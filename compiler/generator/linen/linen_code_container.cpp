...
/*
 ...
 - Architecture files (minimal_linen.py, impulsejax_linen.py) provide the __call__ wrapper
    ...
    *fOut << "def _initialize_carry(self):";
    {
        ...
        *fOut << "# init constants:";
        ...
        inlineSubcontainersFunCalls(fInitInstructions)->accept(gGlobal->gLinenVisitor);
        tab(n + 2, *fOut);
        *fOut << "# inline subcontainers:";
        tab(n + 2, *fOut);
        gGlobal->gLinenVisitor->Tab(n + 2);
        inlineSubcontainersFunCalls(fStaticInitInstructions)->accept(gGlobal->gLinenVisitor);
        tab(n + 2, *fOut);
        *fOut << "# instance clear:";
        tab(n + 2, *fOut);
...
void LinenCodeContainer::generateCompute(int n)
{
    ...
    *fOut << "rngs = nnx.Rngs(rng) if rng is not None else nnx.data(None)";
    ...
    loop->accept(gGlobal->gLinenVisitor);
