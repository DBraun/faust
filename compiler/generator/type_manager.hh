...
// StringTypeManager for Torch backend

class TorchStringTypeManager : public StringTypeManager {
   public:
    TorchStringTypeManager(const std::string& float_macro_name, const std::string& ptr_ref, const std::string& struct_name = "")
        : StringTypeManager(float_macro_name, ptr_ref)
    {
        fPtrRef = ptr_ref;
