...
- [ ] Investigate whether the circular buffer optimization is still beneficial with latest JAX versions
- [ ] Consider making `-mcd` adaptive based on DSP analysis
- [ ] Add automatic detection of DSPs that need higher `-mcd` values
- [ ] Improve documentation with more specific examples from the test suite