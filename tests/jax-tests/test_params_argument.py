...
if __name__ == "__main__":
    print("="*60)
    print("Testing Params Argument Pattern for Batch Processing")
    print("="*60)
    ...
    if all_passed:
        ...
        print("  ✓ params argument enables efficient batch processing")
        print("  ✓ Simple vmap pattern for different params per batch item")
        print("  ✓ Cleaner, more Pythonic API")
        print("  ✓ Backward compatible (params=None uses model defaults)")
    else:
