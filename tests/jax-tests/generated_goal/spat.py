...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		unnorm_funcs = {}
		ui_path = []
		ui_path.append("Spatializer 1x8") 
		self.add_hslider("fHslider1", ui_path, "angle", 0.0, 0.0, 1.0, unnorm_funcs, "linear") 
		self.add_hslider("fHslider0", ui_path, "distance", 0.5, 0.0, 1.0, unnorm_funcs, "linear") 
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow1 = (fSlow0 + jnp.float32(1.0)) 
		fSlow2 = params["fHslider1"] 
		fSlow3 = (jnp.float32(5e-05) * (jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(1.5)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))) * fSlow1)) 
		fSlow4 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(1.375)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow5 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(1.25)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow6 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(1.125)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow7 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(1.0)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow8 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(0.875)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow9 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(0.75)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow10 = (jnp.float32(5e-05) * (fSlow1 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow2 + jnp.float32(0.625)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		...
		state["fRec0"] = (fSlow3 + (jnp.float32(0.9999) * fRec0_temp)) 
		fTemp0 = inputs[0] 
		_result0 = (fTemp0 * state["fRec0"]) 
		state["fRec1"] = (fSlow4 + (jnp.float32(0.9999) * fRec1_temp)) 
		_result1 = (fTemp0 * state["fRec1"]) 
		state["fRec2"] = (fSlow5 + (jnp.float32(0.9999) * fRec2_temp)) 
		_result2 = (fTemp0 * state["fRec2"]) 
		state["fRec3"] = (fSlow6 + (jnp.float32(0.9999) * fRec3_temp)) 
		_result3 = (fTemp0 * state["fRec3"]) 
		state["fRec4"] = (fSlow7 + (jnp.float32(0.9999) * fRec4_temp)) 
		_result4 = (fTemp0 * state["fRec4"]) 
		state["fRec5"] = (fSlow8 + (jnp.float32(0.9999) * fRec5_temp)) 
		_result5 = (fTemp0 * state["fRec5"]) 
		state["fRec6"] = (fSlow9 + (jnp.float32(0.9999) * fRec6_temp)) 
		_result6 = (fTemp0 * state["fRec6"]) 
		state["fRec7"] = (fSlow10 + (jnp.float32(0.9999) * fRec7_temp)) 
		_result7 = (fTemp0 * state["fRec7"]) 
