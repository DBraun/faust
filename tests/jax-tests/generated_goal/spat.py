...
class mydsp(nn.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.array) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow2 = (fSlow0 + jnp.float32(1.0)) 
		fSlow3 = (jnp.float32(5e-05) * (jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(1.5)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))) * fSlow2)) 
		fSlow4 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(1.375)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow5 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(1.25)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow6 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(1.125)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow7 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(1.0)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow8 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(0.875)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow9 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(0.75)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
		fSlow10 = (jnp.float32(5e-05) * (fSlow2 * jnp.sqrt(jnp.maximum(jnp.float32(0.0), (jnp.float32(1.0) - (jnp.float32(8.0) * (fSlow0 * jnp.abs((jnp.mod((fSlow1 + jnp.float32(0.625)), jnp.float32(1.0)) + jnp.float32(-0.5)))))))))) 
