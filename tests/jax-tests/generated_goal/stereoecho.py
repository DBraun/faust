...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		self.add_hslider("fHslider1", ui_path, "feedback", 90.9, 0.0, 1e+02, unnorm_funcs, "linear") 
		self.add_hslider("fHslider0", ui_path, "millisecond", 16.3, 0.0, 1e+03, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.pop()
