...
class mydsp(nnx.Module):
	...
	def __init__(
		...
		self.add_vbargraph("fVbargraph0", ui_path, "vbargraph0", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph1", ui_path, "vbargraph1", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph2", ui_path, "vbargraph2", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph3", ui_path, "vbargraph3", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph4", ui_path, "vbargraph4", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph5", ui_path, "vbargraph5", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph6", ui_path, "vbargraph6", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
		...
		self.add_vbargraph("fVbargraph7", ui_path, "vbargraph7", -7e+01, 5.0, unnorm_funcs) 
		ui_path.pop()
