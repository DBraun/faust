...
class mydsp(nnx.Module):
	...
	def __init__(
		...
		self.add_vslider("fVslider3", ui_path, "knob1", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		self.add_vslider("fVslider4", ui_path, "knob2", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		self.add_vslider("fVslider5", ui_path, "knob3", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.append("sliders") 
		self.add_vslider("fVslider0", ui_path, "vslider1", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		self.add_vslider("fVslider1", ui_path, "vslider2", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		self.add_vslider("fVslider2", ui_path, "vslider3", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.append("vbox") 
		self.add_button("fCheckbox0", ui_path, "check1", unnorm_funcs) 
		self.add_button("fCheckbox1", ui_path, "check2", unnorm_funcs) 
		self.add_nentry("fEntry0", ui_path, "knob0", 6e+01, 0.0, 127.0, 0.1, unnorm_funcs, "linear") 
		ui_path.pop()
		...
		ui_path.pop()
		ui_path.pop()
		self.add_vslider("fVslider6", ui_path, "vslider4", 6e+01, 0.0, 127.0, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray, rng: jax.Array = None) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow2 = params["fEntry0"] 
		fSlow3 = params["fVslider0"] 
		fSlow4 = params["fVslider1"] 
		fSlow5 = params["fVslider2"] 
		fSlow6 = params["fVslider3"] 
		fSlow7 = params["fVslider4"] 
		fSlow8 = params["fVslider5"] 
		fSlow9 = params["fVslider6"] 
		fSlow10 = params["fButton0"] 
		fSlow11 = params["fHslider0"] 
		fSlow12 = params["fVslider7"] 
		fSlow13 = params["fVslider8"] 
		fSlow14 = params["fVslider9"] 
		fSlow15 = params["fEntry1"] 
		fSlow16 = params["fVslider10"] 
		fSlow17 = params["fVslider11"] 
		fSlow18 = params["fVslider12"] 
		fSlow19 = params["fEntry2"] 
		fSlow20 = params["fVslider13"] 
		fSlow21 = params["fVslider14"] 
		fSlow22 = params["fVslider15"] 
		fSlow23 = params["fEntry3"] 
		fSlow24 = params["fVslider16"] 
		fSlow25 = params["fButton1"] 
		fSlow26 = params["fHslider1"] 
		fSlow27 = params["fEntry4"] 
		_result0 = fSlow0 
		_result1 = fSlow1 
		_result2 = fSlow2 
		_result3 = fSlow3 
