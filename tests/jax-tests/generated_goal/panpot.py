...
class mydsp(nn.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow0 = (jnp.float32(0.0055555557) * (params["fEntry0"] + jnp.float32(-9e+01))) 
		fSlow1 = jnp.sqrt(-fSlow0) 
		fSlow2 = jnp.sqrt((fSlow0 + jnp.float32(1.0))) 
		fTemp0 = inputs[0] 
		_result0 = (fSlow1 * fTemp0) 
		_result1 = (fSlow2 * fTemp0) 
