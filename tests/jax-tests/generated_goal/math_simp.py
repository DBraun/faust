...
class mydsp(nn.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		_result4 = fTemp2 
		fTemp3 = (fTemp1 - fTemp0) 
		_result5 = fTemp3 
		_result6 = fTemp2 
		fTemp4 = (fTemp0 - (fTemp1 + inputs[2])) 
		_result7 = fTemp4 
		_result8 = fTemp4 
		_result9 = (jnp.float32(3.0) * fTemp3) 
		_result10 = ((fTemp1 + (jnp.float32(3.0) * fTemp2)) - fTemp0) 
		_result11 = (jnp.float32(4.0) * jnp.abs(fTemp3)) 
		_result12 = -self._fConst0 
		fTemp5 = (self._fConst0 * fTemp0) 
		_result13 = -fTemp5 
		_result14 = -(-fTemp0) 
		_result15 = -fTemp0 
		_result16 = -self._fConst0 
		_result17 = -fTemp5 
		_result18 = fTemp5 
		_result19 = -self._fConst0 
		_result20 = -fTemp5 
		_result21 = self._fConst0 
		fTemp6 = (fTemp0 + fTemp1) 
		_result22 = -fTemp6 
		_result23 = -fTemp6 
		_result24 = -state["fVec0"][10] 
		_result25 = -state["fVec0"][10] 
		fTemp7 = (jnp.float32(3.0) * state["fVec0"][1]) 
		_result26 = fTemp7 
		_result27 = (jnp.float32(3.0) * state["fVec0"][2]) 
		_result28 = fTemp7 
		_result29 = (jnp.float32(4.0) * state["fVec0"][2]) 
		_result30 = -((self._fConst0 * state["fVec0"][1])) 
		_result31 = -((self._fConst0 * state["fVec0"][2])) 
		state["fVec0"] = jnp.roll(state["fVec0"], 1) 
		return state, jnp.stack([_result0,_result1,_result2,_result3,_result4,_result5,_result6,_result7,_result8,_result9,_result10,_result11,_result12,_result13,_result14,_result15,_result16,_result17,_result18,_result19,_result20,_result21,_result22,_result23,_result24,_result25,_result26,_result27,_result28,_result29,_result30,_result31]) 
