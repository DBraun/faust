...
class mydsp(nnx.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray, rng: jax.Array = None) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow5 = (fSlow0 + fSlow4) 
		fSlow6 = ((fSlow2 + fSlow5) + jnp.float32(1.0)) 
		fSlow7 = (fSlow0 / fSlow6) 
		fSlow8 = ((fSlow0 + fSlow2) + (jnp.float32(1.0) - fSlow4)) 
		fSlow9 = (jnp.float32(1.0) / fSlow6) 
		fSlow10 = (fSlow5 + (jnp.float32(1.0) - fSlow2)) 
		fSlow11 = ((fSlow0 + jnp.float32(1.0)) * fSlow3) 
		fSlow12 = (jnp.float32(2.0) * ((fSlow0 + fSlow11) + jnp.float32(-1.0))) 
		fSlow13 = (jnp.float32(2.0) * (fSlow0 + (jnp.float32(-1.0) - fSlow11))) 
		fSlow14 = (fSlow0 + (jnp.float32(1.0) - (fSlow4 + fSlow2))) 
		state["fRec0"] = state["fRec0"].at[0].set((inputs[0] - (fSlow9 * ((fSlow10 * state["fRec0"][2]) - (fSlow12 * state["fRec0"][1]))))) 
		_result0 = (fSlow7 * (((fSlow8 * state["fRec0"][0]) + (fSlow13 * state["fRec0"][1])) + (fSlow14 * state["fRec0"][2]))) 
