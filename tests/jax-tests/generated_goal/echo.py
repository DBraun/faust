...
class mydsp(nnx.Module):
	...
	def __init__(
		...
		self.add_hslider("fHslider0", ui_path, "feedback", 98.4, 0.0, 1e+02, unnorm_funcs, "linear") 
		self.add_hslider("fHslider1", ui_path, "millisecond", 8.1, 0.0, 1e+03, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.pop()
