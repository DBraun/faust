...
class mydsp(nn.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.array) -> Tuple[dict, jnp.ndarray]:
		...
		_result0 = (jnp.int32((jnp.float32(12345.0) * inputs[0])) & jnp.int32((jnp.float32(67895.0) * inputs[1]))).astype(jnp.int32) 
		_result1 = (jnp.int32((jnp.float32(12345.0) * inputs[2])) | jnp.int32((jnp.float32(67895.0) * inputs[3]))).astype(jnp.int32) 
		_result2 = (jnp.int32((jnp.float32(12345.0) * inputs[4])) ^ jnp.int32((jnp.float32(67895.0) * inputs[5]))) 
		_result3 = jnp.where(((jnp.int32((jnp.float32(12345.0) * inputs[6])) & jnp.int32((jnp.float32(67895.0) * inputs[7]))).astype(jnp.int32) != 0), jnp.int32(200), jnp.int32(100)) 
		_result4 = jnp.where(((jnp.int32((jnp.float32(12345.0) * inputs[8])) | jnp.int32((jnp.float32(67895.0) * inputs[9]))).astype(jnp.int32) != 0), jnp.int32(20), jnp.int32(10)) 
		_result5 = jnp.where(((jnp.int32((jnp.float32(12345.0) * inputs[10])) ^ jnp.int32((jnp.float32(67895.0) * inputs[11]))) != 0), jnp.int32(2), jnp.int32(1)) 
		return state, jnp.stack([_result0,_result1,_result2,_result3,_result4,_result5]) 
