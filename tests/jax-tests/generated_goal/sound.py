...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		unnorm_funcs = {}
		ui_path = []
		ui_path.append("sound") 
		self.add_soundfile("fSoundfile0", ui_path, "son", "{'sound1';'sound2'}", unnorm_funcs) 
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		fSoundfile0ca = self.fSoundfile0 
		fSoundfile0ca_le0 = fSoundfile0ca["fLength"] 
		iSlow0 = (fSoundfile0ca_le0[0] + jnp.int32(-1)) 
		...
		fSoundfile0ca_bu_ch1 = fSoundfile0ca_bu1[1] 
		fSoundfile0ca_of2 = fSoundfile0ca["fOffset"] 
		fSoundfile0ca_bu2 = (fSoundfile0ca["fBuffers"]) 
		fSoundfile0ca_bu_ch2 = fSoundfile0ca_bu2[2] 
		fSoundfile0ca_of3 = fSoundfile0ca["fOffset"] 
		fSoundfile0ca_bu3 = (fSoundfile0ca["fBuffers"]) 
		fSoundfile0ca_bu_ch3 = fSoundfile0ca_bu3[3] 
		iRec0_temp = state["iRec0"] 
		state["iRec0"] = (iRec0_temp + jnp.int32(1)) 
		iTemp0 = jnp.maximum(jnp.int32(0), jnp.minimum(state["iRec0"], iSlow0)) 
		_result0 = fSoundfile0ca_bu_ch0[(fSoundfile0ca_of0[0] + iTemp0)] 
		_result1 = fSoundfile0ca_bu_ch1[(fSoundfile0ca_of1[0] + iTemp0)] 
		_result2 = fSoundfile0ca_bu_ch2[(fSoundfile0ca_of2[0] + iTemp0)] 
		_result3 = fSoundfile0ca_bu_ch3[(fSoundfile0ca_of3[0] + iTemp0)] 
