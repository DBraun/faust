...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		unnorm_funcs = {}
		ui_path = []
		ui_path.append("lowboost") 
		self.add_nentry("fEntry0", ui_path, "freq", 1e+02, 2e+01, 1.5e+02, 1.0, unnorm_funcs, "linear") 
		self.add_vslider("fVslider0", ui_path, "gain", 0.0, -2e+01, 2e+01, unnorm_funcs, "linear") 
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.array) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow2 = jnp.power(jnp.float32(1e+01), (jnp.float32(0.05) * params["fVslider0"])) 
