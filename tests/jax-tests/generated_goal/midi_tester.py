...
class mydsp(nnx.Module):
	...
	def __init__(
		...
		self.add_hbargraph("fHbargraph0", ui_path, "Pitchwheel Bool OUT", 0.0, 1.0, unnorm_funcs) 
		self.add_hslider("fHslider0", ui_path, "Pitchwheel Value IN", 0.0, -8192.0, 8191.0, unnorm_funcs, "linear") 
		self.add_hbargraph("fHbargraph1", ui_path, "Pitchwheel Value OUT", -8192.0, 8191.0, unnorm_funcs) 
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray, rng: jax.Array = None) -> Tuple[dict, jnp.ndarray]:
		...
		fHbargraph3 = params["fHslider1"]
		# self.sow("intermediates", "fHbargraph3", fHbargraph3) 
		fHbargraph4 = params["fCheckbox2"]
		# self.sow("intermediates", "fHbargraph4", fHbargraph4) 
		fHbargraph5 = params["fHslider2"]
		# self.sow("intermediates", "fHbargraph5", fHbargraph5) 
		fHbargraph6 = params["fCheckbox3"]
		# self.sow("intermediates", "fHbargraph6", fHbargraph6) 
		fHbargraph7 = params["fHslider3"]
		# self.sow("intermediates", "fHbargraph7", fHbargraph7) 
		fHbargraph8 = params["fCheckbox6"]
		# self.sow("intermediates", "fHbargraph8", fHbargraph8) 
		fHbargraph9 = params["fHslider4"]
		# self.sow("intermediates", "fHbargraph9", fHbargraph9) 
		fHbargraph10 = params["fCheckbox7"]
