...
class mydsp(nnx.Module):
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray, rng: jax.Array = None) -> Tuple[dict, jnp.ndarray]:
		...
		_result0 = (jnp.int32(10)) 
		_result1 = (jnp.int32(-10)) 
		_result2 = (jnp.int32(2147483647)) 
		_result3 = (jnp.int32(-2147483647)) 
		_result4 = (jnp.int32(-2147483648)) 
		_result5 = (jnp.int32(-2147483648)) 
		_result6 = (jnp.int32(-2147483647)) 
		_result7 = (jnp.int32(2147483647)) 
		_result8 = (jnp.int32(-1)) 
		_result9 = (jnp.int32(1)) 
		_result10 = (jnp.int32(0)) 
		_result11 = (jnp.int32(0)) 
		_result12 = (jnp.int32(1)) 
		_result13 = (jnp.int32(-1)) 
		_result14 = (jnp.int32(2)) 
		_result15 = (jnp.int32(-2)) 
		return state, jnp.stack([_result0,_result1,_result2,_result3,_result4,_result5,_result6,_result7,_result8,_result9,_result10,_result11,_result12,_result13,_result14,_result15]) 
