...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		self.add_vbargraph("fVbargraph5", ui_path, "bar0", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph6", ui_path, "bar1", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph7", ui_path, "bar2", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph8", ui_path, "bar3", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph9", ui_path, "bar4", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph0", ui_path, "foo0", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph1", ui_path, "foo1", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph2", ui_path, "foo2", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph3", ui_path, "foo3", 0.0, 1e+01) 
		self.add_vbargraph("fVbargraph4", ui_path, "foo4", 0.0, 1e+01) 
		ui_path.pop()
