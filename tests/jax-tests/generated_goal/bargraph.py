...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		unnorm_funcs = {}
		ui_path = []
		ui_path.append("bargraph") 
		self.add_vbargraph("fVbargraph5", ui_path, "bar0", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph6", ui_path, "bar1", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph7", ui_path, "bar2", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph8", ui_path, "bar3", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph9", ui_path, "bar4", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph0", ui_path, "foo0", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph1", ui_path, "foo1", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph2", ui_path, "foo2", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph3", ui_path, "foo3", 0.0, 1e+01, unnorm_funcs) 
		self.add_vbargraph("fVbargraph4", ui_path, "foo4", 0.0, 1e+01, unnorm_funcs) 
		ui_path.pop()
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		_result8 = fSlow8 
		_result9 = fSlow9 
		return state, jnp.stack([_result0,_result1,_result2,_result3,_result4,_result5,_result6,_result7,_result8,_result9]) 
