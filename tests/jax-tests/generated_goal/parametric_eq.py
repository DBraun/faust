...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		self.add_vbargraph("fVbargraph19", ui_path, "vbargraph0", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph18", ui_path, "vbargraph1", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph17", ui_path, "vbargraph2", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph16", ui_path, "vbargraph3", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph15", ui_path, "vbargraph4", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph14", ui_path, "vbargraph5", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph13", ui_path, "vbargraph6", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph12", ui_path, "vbargraph7", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph11", ui_path, "vbargraph8", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph10", ui_path, "vbargraph9", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph9", ui_path, "vbargraph10", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph8", ui_path, "vbargraph11", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph7", ui_path, "vbargraph12", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph6", ui_path, "vbargraph13", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph5", ui_path, "vbargraph14", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph4", ui_path, "vbargraph15", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph3", ui_path, "vbargraph16", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph2", ui_path, "vbargraph17", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph1", ui_path, "vbargraph18", -5e+01, 1e+01) 
		self.add_vbargraph("fVbargraph0", ui_path, "vbargraph19", -5e+01, 1e+01) 
		ui_path.pop()
