...
class mydsp(nn.Module):
	...
	def setup(self):
		...
		self.add_hslider("fHslider2", ui_path, "Slope of Spectral Tilt across Band", -0.5, -1.0, 1.0, unnorm_funcs, "linear") 
		ui_path.append("Spectral Tilt Filter") 
		self.add_button("fCheckbox0", ui_path, "Bypass Spectral Tilt", unnorm_funcs) 
		ui_path.pop()
		self.add_hslider("fHslider0", ui_path, "Band Start Frequency", 1e+02, 2e+01, 1e+04, unnorm_funcs, "linear") 
		self.add_hslider("fHslider1", ui_path, "Band Width", 5e+03, 1e+02, 1e+04, unnorm_funcs, "linear") 
		ui_path.pop()
		...
		self.add_hslider("fHslider3", ui_path, "Level Averaging Time", 1e+02, 1.0, 1e+04, unnorm_funcs, "log") 
		self.add_hslider("fHslider4", ui_path, "Level dB Offset", 5e+01, 0.0, 1e+02, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.pop()
		ui_path.pop()
		...
		self._fConst184 = (np.float32(0.25) * self._fConst0) 
		self._fConst185 = (np.float32(0.041666668) * np.power(self._fConst0, np.float32(2.0))) 
		self._fConst186 = (np.float32(0.0052083335) * np.power(self._fConst0, np.float32(3.0))) 
		self._fConst187 = (np.float32(1.0) / np.tan((np.float32(0.5) / self._fConst0))) 
		self._fConst188 = (np.float32(3.1415927) / self._fConst0) 
	...
	def _initialize_carry(self, x: jnp.ndarray, length: int):
		...
		state["iRec58"] = np.int32(0)
		# Initialize array delays
		state["iVec0"] = np.zeros((4,), dtype=np.int32)
		state["fRec59"] = np.zeros((4,), dtype=np.float32)
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray) -> Tuple[dict, jnp.ndarray]:
		...
		iSlow2 = jnp.int32(params["fCheckbox2"]) 
		iSlow3 = jnp.int32((params["fEntry0"] + jnp.float32(-1.0))) 
		iSlow4 = (iSlow3 >= jnp.int32(2)).astype(jnp.int32) 
		iSlow5 = (iSlow3 >= jnp.int32(1)).astype(jnp.int32) 
		fSlow6 = params["fVslider0"] 
		fSlow7 = jnp.where(((fSlow6 > jnp.float32(0.0)).astype(jnp.int32) != 0), jnp.exp(-((self._fConst183 / fSlow6))), jnp.float32(0.0)) 
		fSlow8 = ((jnp.float32(4.4e+02) * jnp.power(jnp.float32(2.0), (jnp.float32(0.083333336) * (params["fVslider1"] + jnp.float32(-49.0))))) * (jnp.float32(1.0) - fSlow7)) 
		fSlow9 = ((jnp.float32(0.01) * params["fVslider2"]) + jnp.float32(1.0)) 
		iSlow10 = (iSlow3 >= jnp.int32(3)).astype(jnp.int32) 
		fSlow11 = ((jnp.float32(0.01) * params["fVslider3"]) + jnp.float32(1.0)) 
		fSlow12 = (jnp.float32(0.001) * jnp.power(jnp.float32(1e+01), (jnp.float32(0.05) * params["fVslider4"]))) 
		iSlow13 = jnp.int32(params["fCheckbox3"]) 
		fSlow14 = params["fHslider0"] 
		fSlow15 = jnp.tan((self._fConst188 * fSlow14)) 
		fSlow16 = jnp.power(((fSlow14 + params["fHslider1"]) / fSlow14), jnp.float32(0.11111111)) 
		fSlow17 = params["fHslider2"] 
		fSlow18 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, -fSlow17)))) 
		fSlow19 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow18) / fSlow15)) 
		fSlow20 = (fSlow19 - self._fConst187) 
		fSlow21 = (self._fConst187 + fSlow19) 
		fSlow22 = (jnp.float32(6.2831855) * fSlow14) 
		fSlow23 = (fSlow22 - self._fConst187) 
		fSlow24 = (jnp.float32(1.0) / (self._fConst187 + fSlow22)) 
		fSlow25 = (fSlow15 / fSlow18) 
		fSlow26 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(1.0) - fSlow17))))) 
		fSlow27 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow26) / fSlow15)) 
		fSlow28 = (fSlow27 - self._fConst187) 
		fSlow29 = ((fSlow15 * (self._fConst187 + fSlow27)) / fSlow18) 
		fSlow30 = jnp.tan((self._fConst188 * (fSlow14 * fSlow16))) 
		fSlow31 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow30) / fSlow15)) 
		fSlow32 = (fSlow31 - self._fConst187) 
		fSlow33 = (jnp.float32(1.0) / (self._fConst187 + fSlow31)) 
		fSlow34 = (fSlow30 / fSlow26) 
		fSlow35 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(2.0) - fSlow17))))) 
		fSlow36 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow35) / fSlow15)) 
		fSlow37 = (fSlow36 - self._fConst187) 
		fSlow38 = ((fSlow30 * (self._fConst187 + fSlow36)) / fSlow26) 
		fSlow39 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(2.0))))) 
		fSlow40 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow39) / fSlow15)) 
		fSlow41 = (fSlow40 - self._fConst187) 
		fSlow42 = (jnp.float32(1.0) / (self._fConst187 + fSlow40)) 
		fSlow43 = (fSlow39 / fSlow35) 
		fSlow44 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(3.0) - fSlow17))))) 
		fSlow45 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow44) / fSlow15)) 
		fSlow46 = (fSlow45 - self._fConst187) 
		fSlow47 = ((fSlow39 * (self._fConst187 + fSlow45)) / fSlow35) 
		fSlow48 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(3.0))))) 
		fSlow49 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow48) / fSlow15)) 
		fSlow50 = (fSlow49 - self._fConst187) 
		fSlow51 = (jnp.float32(1.0) / (self._fConst187 + fSlow49)) 
		fSlow52 = (fSlow48 / fSlow44) 
		fSlow53 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(4.0) - fSlow17))))) 
		fSlow54 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow53) / fSlow15)) 
		fSlow55 = (fSlow54 - self._fConst187) 
		fSlow56 = ((fSlow48 * (self._fConst187 + fSlow54)) / fSlow44) 
		fSlow57 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(4.0))))) 
		fSlow58 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow57) / fSlow15)) 
		fSlow59 = (fSlow58 - self._fConst187) 
		fSlow60 = (jnp.float32(1.0) / (self._fConst187 + fSlow58)) 
		fSlow61 = (fSlow57 / fSlow53) 
		fSlow62 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(5.0) - fSlow17))))) 
		fSlow63 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow62) / fSlow15)) 
		fSlow64 = (fSlow63 - self._fConst187) 
		fSlow65 = ((fSlow57 * (self._fConst187 + fSlow63)) / fSlow53) 
		fSlow66 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(5.0))))) 
		fSlow67 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow66) / fSlow15)) 
		fSlow68 = (fSlow67 - self._fConst187) 
		fSlow69 = (jnp.float32(1.0) / (self._fConst187 + fSlow67)) 
		fSlow70 = (fSlow66 / fSlow62) 
		fSlow71 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(6.0) - fSlow17))))) 
		fSlow72 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow71) / fSlow15)) 
		fSlow73 = (fSlow72 - self._fConst187) 
		fSlow74 = ((fSlow66 * (self._fConst187 + fSlow72)) / fSlow62) 
		fSlow75 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(6.0))))) 
		fSlow76 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow75) / fSlow15)) 
		fSlow77 = (fSlow76 - self._fConst187) 
		fSlow78 = (jnp.float32(1.0) / (self._fConst187 + fSlow76)) 
		fSlow79 = (fSlow75 / fSlow71) 
		fSlow80 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(7.0) - fSlow17))))) 
		fSlow81 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow80) / fSlow15)) 
		fSlow82 = (fSlow81 - self._fConst187) 
		fSlow83 = ((fSlow75 * (self._fConst187 + fSlow81)) / fSlow71) 
		fSlow84 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(7.0))))) 
		fSlow85 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow84) / fSlow15)) 
		fSlow86 = (fSlow85 - self._fConst187) 
		fSlow87 = (jnp.float32(1.0) / (self._fConst187 + fSlow85)) 
		fSlow88 = (fSlow84 / fSlow80) 
		fSlow89 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(8.0) - fSlow17))))) 
		fSlow90 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow89) / fSlow15)) 
		fSlow91 = (fSlow90 - self._fConst187) 
		fSlow92 = ((fSlow84 * (self._fConst187 + fSlow90)) / fSlow80) 
		fSlow93 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(8.0))))) 
		fSlow94 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow93) / fSlow15)) 
		fSlow95 = (fSlow94 - self._fConst187) 
		fSlow96 = (jnp.float32(1.0) / (self._fConst187 + fSlow94)) 
		fSlow97 = (fSlow93 / fSlow89) 
		fSlow98 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, (jnp.float32(9.0) - fSlow17))))) 
		fSlow99 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow98) / fSlow15)) 
		fSlow100 = (fSlow99 - self._fConst187) 
		fSlow101 = ((fSlow93 * (self._fConst187 + fSlow99)) / fSlow89) 
		fSlow102 = jnp.tan((self._fConst188 * (fSlow14 * jnp.power(fSlow16, jnp.float32(9.0))))) 
		fSlow103 = (jnp.float32(6.2831855) * ((fSlow14 * fSlow102) / fSlow15)) 
		fSlow104 = (fSlow103 - self._fConst187) 
		fSlow105 = (jnp.float32(1.0) / (self._fConst187 + fSlow103)) 
		fSlow106 = (fSlow102 / fSlow98) 
		fSlow107 = params["fHslider3"] 
		fSlow108 = jnp.where((((jnp.float32(0.001) * fSlow107) > jnp.float32(0.0)).astype(jnp.int32) != 0), jnp.exp(-((self._fConst287 / fSlow107))), jnp.float32(0.0)) 
		fSlow109 = (jnp.float32(1.0) - fSlow108) 
		fSlow110 = params["fHslider4"] 
		...
		state["fRec54"] = ((fRec54_temp * fSlow7) + fSlow8) 
		fTemp0 = jnp.maximum(jnp.float32(2e+01), jnp.abs((fSlow9 * state["fRec54"]))) 
		fTemp1 = (fRec53_temp + (self._fConst183 * fTemp0)) 
		state["fRec53"] = (fTemp1 - jnp.floor(fTemp1)) 
		fTemp2 = (jnp.float32(2.0) * state["fRec53"]) 
		...
		fTemp13 = jnp.maximum(jnp.float32(2e+01), jnp.abs((fSlow11 * state["fRec54"]))) 
		fTemp14 = (fRec55_temp + (self._fConst183 * fTemp13)) 
		state["fRec55"] = (fTemp14 - jnp.floor(fTemp14)) 
		fTemp15 = (jnp.float32(2.0) * state["fRec55"]) 
		...
		fTemp23 = jnp.maximum(jnp.float32(2e+01), jnp.abs(state["fRec54"])) 
		fTemp24 = (fRec56_temp + (self._fConst183 * fTemp23)) 
		state["fRec56"] = (fTemp24 - jnp.floor(fTemp24)) 
		fTemp25 = (jnp.float32(2.0) * state["fRec56"]) 
		...
		state["fRec57"] = (fSlow12 + (jnp.float32(0.999) * fRec57_temp)) 
		state["iRec58"] = ((jnp.int32(1103515245) * iRec58_temp) + jnp.int32(12345)) 
		fTemp33 = (jnp.float32(4.656613e-10) * (state["iRec58"])) 
		state["fRec59"] = state["fRec59"].at[0].set((((jnp.float32(0.5221894) * state["fRec59"][3]) + (fTemp33 + (jnp.float32(2.494956) * state["fRec59"][1]))) - (jnp.float32(2.0172658) * state["fRec59"][2]))) 
		fTemp34 = (state["fRec57"] * jnp.where((iSlow1 != 0), inputs[0], jnp.where((iSlow2 != 0), jnp.where((iSlow13 != 0), (((jnp.float32(0.049922034) * state["fRec59"][0]) + (jnp.float32(0.0506127) * state["fRec59"][2])) - ((jnp.float32(0.095993534) * state["fRec59"][1]) + (jnp.float32(0.004408786) * state["fRec59"][3]))), fTemp33), (jnp.float32(0.33333334) * (state["fRec57"] * ((jnp.where((iSlow4 != 0), jnp.where((iSlow10 != 0), (self._fConst186 * ((fTemp12 * (fTemp32 - fVec18_temp)) / fTemp23)), (self._fConst185 * ((fTemp8 * (fTemp29 - fVec15_temp)) / fTemp23))), jnp.where((iSlow5 != 0), (self._fConst184 * ((fTemp5 * (fTemp27 - fVec13_temp)) / fTemp23)), fTemp26)) + jnp.where((iSlow4 != 0), jnp.where((iSlow10 != 0), (self._fConst186 * ((fTemp12 * (fTemp22 - fVec12_temp)) / fTemp13)), (self._fConst185 * ((fTemp8 * (fTemp19 - fVec9_temp)) / fTemp13))), jnp.where((iSlow5 != 0), (self._fConst184 * ((fTemp5 * (fTemp17 - fVec7_temp)) / fTemp13)), fTemp16))) + jnp.where((iSlow4 != 0), jnp.where((iSlow10 != 0), (self._fConst186 * ((fTemp12 * (fTemp11 - fVec6_temp)) / fTemp0)), (self._fConst185 * ((fTemp8 * (fTemp7 - fVec3_temp)) / fTemp0))), jnp.where((iSlow5 != 0), (self._fConst184 * ((fTemp5 * (fTemp4 - fVec1_temp)) / fTemp0)), fTemp3)))))))) 
		fTemp35 = jnp.where((iSlow0 != 0), jnp.float32(0.0), fTemp34) 
		state["fVec19"] = jnp.float32(fTemp35) 
		state["fRec52"] = -((fSlow24 * ((fSlow23 * fRec52_temp) - ((fSlow21 * fTemp35) + (fSlow20 * fVec19_temp))))) 
		state["fVec20"] = (fSlow25 * state["fRec52"]) 
		state["fRec51"] = -((fSlow33 * ((fSlow32 * fRec51_temp) - ((fSlow29 * state["fRec52"]) + (fSlow28 * fVec20_temp))))) 
		state["fVec21"] = (fSlow34 * state["fRec51"]) 
		state["fRec50"] = -((fSlow42 * ((fSlow41 * fRec50_temp) - ((fSlow38 * state["fRec51"]) + (fSlow37 * fVec21_temp))))) 
		state["fVec22"] = (fSlow43 * state["fRec50"]) 
		state["fRec49"] = -((fSlow51 * ((fSlow50 * fRec49_temp) - ((fSlow47 * state["fRec50"]) + (fSlow46 * fVec22_temp))))) 
		state["fVec23"] = (fSlow52 * state["fRec49"]) 
		state["fRec48"] = -((fSlow60 * ((fSlow59 * fRec48_temp) - ((fSlow56 * state["fRec49"]) + (fSlow55 * fVec23_temp))))) 
		state["fVec24"] = (fSlow61 * state["fRec48"]) 
		state["fRec47"] = -((fSlow69 * ((fSlow68 * fRec47_temp) - ((fSlow65 * state["fRec48"]) + (fSlow64 * fVec24_temp))))) 
		state["fVec25"] = (fSlow70 * state["fRec47"]) 
		state["fRec46"] = -((fSlow78 * ((fSlow77 * fRec46_temp) - ((fSlow74 * state["fRec47"]) + (fSlow73 * fVec25_temp))))) 
		state["fVec26"] = (fSlow79 * state["fRec46"]) 
		state["fRec45"] = -((fSlow87 * ((fSlow86 * fRec45_temp) - ((fSlow83 * state["fRec46"]) + (fSlow82 * fVec26_temp))))) 
		state["fVec27"] = (fSlow88 * state["fRec45"]) 
		state["fRec44"] = -((fSlow96 * ((fSlow95 * fRec44_temp) - ((fSlow92 * state["fRec45"]) + (fSlow91 * fVec27_temp))))) 
		state["fVec28"] = (fSlow97 * state["fRec44"]) 
		state["fRec43"] = -((fSlow105 * ((fSlow104 * fRec43_temp) - ((fSlow101 * state["fRec44"]) + (fSlow100 * fVec28_temp))))) 
		fTemp36 = jnp.where((iSlow0 != 0), fTemp34, (fSlow106 * state["fRec43"])) 
		state["fRec42"] = state["fRec42"].at[0].set((fTemp36 - (self._fConst182 * ((self._fConst181 * state["fRec42"][2]) + (self._fConst180 * state["fRec42"][1]))))) 
		...
		fTemp37 = (self._fConst176 * (((self._fConst194 * state["fRec40"][0]) + (self._fConst195 * state["fRec40"][1])) + (self._fConst194 * state["fRec40"][2]))) 
		state["fRec39"] = state["fRec39"].at[0].set((fTemp37 - (self._fConst169 * ((self._fConst168 * state["fRec39"][2]) + (self._fConst167 * state["fRec39"][1]))))) 
		...
		fTemp38 = (self._fConst163 * (((self._fConst201 * state["fRec37"][0]) + (self._fConst202 * state["fRec37"][1])) + (self._fConst201 * state["fRec37"][2]))) 
		state["fRec36"] = state["fRec36"].at[0].set((fTemp38 - (self._fConst156 * ((self._fConst155 * state["fRec36"][2]) + (self._fConst154 * state["fRec36"][1]))))) 
		...
		fTemp39 = (self._fConst150 * (((self._fConst208 * state["fRec34"][0]) + (self._fConst209 * state["fRec34"][1])) + (self._fConst208 * state["fRec34"][2]))) 
		state["fRec33"] = state["fRec33"].at[0].set((fTemp39 - (self._fConst143 * ((self._fConst142 * state["fRec33"][2]) + (self._fConst141 * state["fRec33"][1]))))) 
		...
		fTemp40 = (self._fConst137 * (((self._fConst215 * state["fRec31"][0]) + (self._fConst216 * state["fRec31"][1])) + (self._fConst215 * state["fRec31"][2]))) 
		state["fRec30"] = state["fRec30"].at[0].set((fTemp40 - (self._fConst130 * ((self._fConst129 * state["fRec30"][2]) + (self._fConst128 * state["fRec30"][1]))))) 
		...
		fTemp41 = (self._fConst124 * (((self._fConst222 * state["fRec28"][0]) + (self._fConst223 * state["fRec28"][1])) + (self._fConst222 * state["fRec28"][2]))) 
		state["fRec27"] = state["fRec27"].at[0].set((fTemp41 - (self._fConst117 * ((self._fConst116 * state["fRec27"][2]) + (self._fConst115 * state["fRec27"][1]))))) 
		...
		fTemp42 = (self._fConst111 * (((self._fConst229 * state["fRec25"][0]) + (self._fConst230 * state["fRec25"][1])) + (self._fConst229 * state["fRec25"][2]))) 
		state["fRec24"] = state["fRec24"].at[0].set((fTemp42 - (self._fConst104 * ((self._fConst103 * state["fRec24"][2]) + (self._fConst102 * state["fRec24"][1]))))) 
		...
		fTemp43 = (self._fConst98 * (((self._fConst236 * state["fRec22"][0]) + (self._fConst237 * state["fRec22"][1])) + (self._fConst236 * state["fRec22"][2]))) 
		state["fRec21"] = state["fRec21"].at[0].set((fTemp43 - (self._fConst91 * ((self._fConst90 * state["fRec21"][2]) + (self._fConst89 * state["fRec21"][1]))))) 
		...
		fTemp44 = (self._fConst85 * (((self._fConst243 * state["fRec19"][0]) + (self._fConst244 * state["fRec19"][1])) + (self._fConst243 * state["fRec19"][2]))) 
		state["fRec18"] = state["fRec18"].at[0].set((fTemp44 - (self._fConst78 * ((self._fConst77 * state["fRec18"][2]) + (self._fConst76 * state["fRec18"][1]))))) 
		...
		fTemp45 = (self._fConst72 * (((self._fConst250 * state["fRec16"][0]) + (self._fConst251 * state["fRec16"][1])) + (self._fConst250 * state["fRec16"][2]))) 
		state["fRec15"] = state["fRec15"].at[0].set((fTemp45 - (self._fConst65 * ((self._fConst64 * state["fRec15"][2]) + (self._fConst63 * state["fRec15"][1]))))) 
		...
		fTemp46 = (self._fConst59 * (((self._fConst257 * state["fRec13"][0]) + (self._fConst258 * state["fRec13"][1])) + (self._fConst257 * state["fRec13"][2]))) 
		state["fRec12"] = state["fRec12"].at[0].set((fTemp46 - (self._fConst52 * ((self._fConst51 * state["fRec12"][2]) + (self._fConst50 * state["fRec12"][1]))))) 
		...
		fTemp47 = (self._fConst46 * (((self._fConst264 * state["fRec10"][0]) + (self._fConst265 * state["fRec10"][1])) + (self._fConst264 * state["fRec10"][2]))) 
		state["fRec9"] = state["fRec9"].at[0].set((fTemp47 - (self._fConst39 * ((self._fConst38 * state["fRec9"][2]) + (self._fConst37 * state["fRec9"][1]))))) 
		...
		fTemp48 = (self._fConst33 * (((self._fConst271 * state["fRec7"][0]) + (self._fConst272 * state["fRec7"][1])) + (self._fConst271 * state["fRec7"][2]))) 
		state["fRec6"] = state["fRec6"].at[0].set((fTemp48 - (self._fConst26 * ((self._fConst25 * state["fRec6"][2]) + (self._fConst24 * state["fRec6"][1]))))) 
		...
		fTemp49 = (self._fConst20 * (((self._fConst278 * state["fRec4"][0]) + (self._fConst279 * state["fRec4"][1])) + (self._fConst278 * state["fRec4"][2]))) 
		state["fRec3"] = state["fRec3"].at[0].set((fTemp49 - (self._fConst13 * ((self._fConst12 * state["fRec3"][2]) + (self._fConst11 * state["fRec3"][1]))))) 
		...
		state["fRec0"] = ((fSlow108 * fRec0_temp) + (fSlow109 * jnp.abs((self._fConst7 * (((self._fConst285 * state["fRec1"][0]) + (self._fConst286 * state["fRec1"][1])) + (self._fConst285 * state["fRec1"][2])))))) 
		fVbargraph0 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec0"])))
		self.sow("intermediates", "fVbargraph0", fVbargraph0) 
		state["fRec63"] = state["fRec63"].at[0].set((fTemp49 - (self._fConst296 * ((self._fConst295 * state["fRec63"][2]) + (self._fConst294 * state["fRec63"][1]))))) 
		state["fRec62"] = state["fRec62"].at[0].set(((self._fConst296 * (((self._fConst298 * state["fRec63"][0]) + (self._fConst299 * state["fRec63"][1])) + (self._fConst298 * state["fRec63"][2]))) - (self._fConst293 * ((self._fConst292 * state["fRec62"][2]) + (self._fConst291 * state["fRec62"][1]))))) 
		state["fRec61"] = state["fRec61"].at[0].set(((self._fConst293 * (((self._fConst301 * state["fRec62"][0]) + (self._fConst302 * state["fRec62"][1])) + (self._fConst301 * state["fRec62"][2]))) - (self._fConst290 * ((self._fConst289 * state["fRec61"][2]) + (self._fConst288 * state["fRec61"][1]))))) 
		state["fRec60"] = ((fSlow108 * fRec60_temp) + (fSlow109 * jnp.abs((self._fConst290 * (((self._fConst304 * state["fRec61"][0]) + (self._fConst305 * state["fRec61"][1])) + (self._fConst304 * state["fRec61"][2])))))) 
		fVbargraph1 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec60"])))
		self.sow("intermediates", "fVbargraph1", fVbargraph1) 
		state["fRec67"] = state["fRec67"].at[0].set((fTemp48 - (self._fConst314 * ((self._fConst313 * state["fRec67"][2]) + (self._fConst312 * state["fRec67"][1]))))) 
		state["fRec66"] = state["fRec66"].at[0].set(((self._fConst314 * (((self._fConst316 * state["fRec67"][0]) + (self._fConst317 * state["fRec67"][1])) + (self._fConst316 * state["fRec67"][2]))) - (self._fConst311 * ((self._fConst310 * state["fRec66"][2]) + (self._fConst309 * state["fRec66"][1]))))) 
		state["fRec65"] = state["fRec65"].at[0].set(((self._fConst311 * (((self._fConst319 * state["fRec66"][0]) + (self._fConst320 * state["fRec66"][1])) + (self._fConst319 * state["fRec66"][2]))) - (self._fConst308 * ((self._fConst307 * state["fRec65"][2]) + (self._fConst306 * state["fRec65"][1]))))) 
		state["fRec64"] = ((fSlow108 * fRec64_temp) + (fSlow109 * jnp.abs((self._fConst308 * (((self._fConst322 * state["fRec65"][0]) + (self._fConst323 * state["fRec65"][1])) + (self._fConst322 * state["fRec65"][2])))))) 
		fVbargraph2 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec64"])))
		self.sow("intermediates", "fVbargraph2", fVbargraph2) 
		state["fRec71"] = state["fRec71"].at[0].set((fTemp47 - (self._fConst332 * ((self._fConst331 * state["fRec71"][2]) + (self._fConst330 * state["fRec71"][1]))))) 
		state["fRec70"] = state["fRec70"].at[0].set(((self._fConst332 * (((self._fConst334 * state["fRec71"][0]) + (self._fConst335 * state["fRec71"][1])) + (self._fConst334 * state["fRec71"][2]))) - (self._fConst329 * ((self._fConst328 * state["fRec70"][2]) + (self._fConst327 * state["fRec70"][1]))))) 
		state["fRec69"] = state["fRec69"].at[0].set(((self._fConst329 * (((self._fConst337 * state["fRec70"][0]) + (self._fConst338 * state["fRec70"][1])) + (self._fConst337 * state["fRec70"][2]))) - (self._fConst326 * ((self._fConst325 * state["fRec69"][2]) + (self._fConst324 * state["fRec69"][1]))))) 
		state["fRec68"] = ((fSlow108 * fRec68_temp) + (fSlow109 * jnp.abs((self._fConst326 * (((self._fConst340 * state["fRec69"][0]) + (self._fConst341 * state["fRec69"][1])) + (self._fConst340 * state["fRec69"][2])))))) 
		fVbargraph3 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec68"])))
		self.sow("intermediates", "fVbargraph3", fVbargraph3) 
		state["fRec75"] = state["fRec75"].at[0].set((fTemp46 - (self._fConst350 * ((self._fConst349 * state["fRec75"][2]) + (self._fConst348 * state["fRec75"][1]))))) 
		state["fRec74"] = state["fRec74"].at[0].set(((self._fConst350 * (((self._fConst352 * state["fRec75"][0]) + (self._fConst353 * state["fRec75"][1])) + (self._fConst352 * state["fRec75"][2]))) - (self._fConst347 * ((self._fConst346 * state["fRec74"][2]) + (self._fConst345 * state["fRec74"][1]))))) 
		state["fRec73"] = state["fRec73"].at[0].set(((self._fConst347 * (((self._fConst355 * state["fRec74"][0]) + (self._fConst356 * state["fRec74"][1])) + (self._fConst355 * state["fRec74"][2]))) - (self._fConst344 * ((self._fConst343 * state["fRec73"][2]) + (self._fConst342 * state["fRec73"][1]))))) 
		state["fRec72"] = ((fSlow108 * fRec72_temp) + (fSlow109 * jnp.abs((self._fConst344 * (((self._fConst358 * state["fRec73"][0]) + (self._fConst359 * state["fRec73"][1])) + (self._fConst358 * state["fRec73"][2])))))) 
		fVbargraph4 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec72"])))
		self.sow("intermediates", "fVbargraph4", fVbargraph4) 
		state["fRec79"] = state["fRec79"].at[0].set((fTemp45 - (self._fConst368 * ((self._fConst367 * state["fRec79"][2]) + (self._fConst366 * state["fRec79"][1]))))) 
		state["fRec78"] = state["fRec78"].at[0].set(((self._fConst368 * (((self._fConst370 * state["fRec79"][0]) + (self._fConst371 * state["fRec79"][1])) + (self._fConst370 * state["fRec79"][2]))) - (self._fConst365 * ((self._fConst364 * state["fRec78"][2]) + (self._fConst363 * state["fRec78"][1]))))) 
		state["fRec77"] = state["fRec77"].at[0].set(((self._fConst365 * (((self._fConst373 * state["fRec78"][0]) + (self._fConst374 * state["fRec78"][1])) + (self._fConst373 * state["fRec78"][2]))) - (self._fConst362 * ((self._fConst361 * state["fRec77"][2]) + (self._fConst360 * state["fRec77"][1]))))) 
		state["fRec76"] = ((fSlow108 * fRec76_temp) + (fSlow109 * jnp.abs((self._fConst362 * (((self._fConst376 * state["fRec77"][0]) + (self._fConst377 * state["fRec77"][1])) + (self._fConst376 * state["fRec77"][2])))))) 
		fVbargraph5 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec76"])))
		self.sow("intermediates", "fVbargraph5", fVbargraph5) 
		state["fRec83"] = state["fRec83"].at[0].set((fTemp44 - (self._fConst386 * ((self._fConst385 * state["fRec83"][2]) + (self._fConst384 * state["fRec83"][1]))))) 
		state["fRec82"] = state["fRec82"].at[0].set(((self._fConst386 * (((self._fConst388 * state["fRec83"][0]) + (self._fConst389 * state["fRec83"][1])) + (self._fConst388 * state["fRec83"][2]))) - (self._fConst383 * ((self._fConst382 * state["fRec82"][2]) + (self._fConst381 * state["fRec82"][1]))))) 
		state["fRec81"] = state["fRec81"].at[0].set(((self._fConst383 * (((self._fConst391 * state["fRec82"][0]) + (self._fConst392 * state["fRec82"][1])) + (self._fConst391 * state["fRec82"][2]))) - (self._fConst380 * ((self._fConst379 * state["fRec81"][2]) + (self._fConst378 * state["fRec81"][1]))))) 
		state["fRec80"] = ((fSlow108 * fRec80_temp) + (fSlow109 * jnp.abs((self._fConst380 * (((self._fConst394 * state["fRec81"][0]) + (self._fConst395 * state["fRec81"][1])) + (self._fConst394 * state["fRec81"][2])))))) 
		fVbargraph6 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec80"])))
		self.sow("intermediates", "fVbargraph6", fVbargraph6) 
		state["fRec87"] = state["fRec87"].at[0].set((fTemp43 - (self._fConst404 * ((self._fConst403 * state["fRec87"][2]) + (self._fConst402 * state["fRec87"][1]))))) 
		state["fRec86"] = state["fRec86"].at[0].set(((self._fConst404 * (((self._fConst406 * state["fRec87"][0]) + (self._fConst407 * state["fRec87"][1])) + (self._fConst406 * state["fRec87"][2]))) - (self._fConst401 * ((self._fConst400 * state["fRec86"][2]) + (self._fConst399 * state["fRec86"][1]))))) 
		state["fRec85"] = state["fRec85"].at[0].set(((self._fConst401 * (((self._fConst409 * state["fRec86"][0]) + (self._fConst410 * state["fRec86"][1])) + (self._fConst409 * state["fRec86"][2]))) - (self._fConst398 * ((self._fConst397 * state["fRec85"][2]) + (self._fConst396 * state["fRec85"][1]))))) 
		state["fRec84"] = ((fSlow108 * fRec84_temp) + (fSlow109 * jnp.abs((self._fConst398 * (((self._fConst412 * state["fRec85"][0]) + (self._fConst413 * state["fRec85"][1])) + (self._fConst412 * state["fRec85"][2])))))) 
		fVbargraph7 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec84"])))
		self.sow("intermediates", "fVbargraph7", fVbargraph7) 
		state["fRec91"] = state["fRec91"].at[0].set((fTemp42 - (self._fConst422 * ((self._fConst421 * state["fRec91"][2]) + (self._fConst420 * state["fRec91"][1]))))) 
		state["fRec90"] = state["fRec90"].at[0].set(((self._fConst422 * (((self._fConst424 * state["fRec91"][0]) + (self._fConst425 * state["fRec91"][1])) + (self._fConst424 * state["fRec91"][2]))) - (self._fConst419 * ((self._fConst418 * state["fRec90"][2]) + (self._fConst417 * state["fRec90"][1]))))) 
		state["fRec89"] = state["fRec89"].at[0].set(((self._fConst419 * (((self._fConst427 * state["fRec90"][0]) + (self._fConst428 * state["fRec90"][1])) + (self._fConst427 * state["fRec90"][2]))) - (self._fConst416 * ((self._fConst415 * state["fRec89"][2]) + (self._fConst414 * state["fRec89"][1]))))) 
		state["fRec88"] = ((fSlow108 * fRec88_temp) + (fSlow109 * jnp.abs((self._fConst416 * (((self._fConst430 * state["fRec89"][0]) + (self._fConst431 * state["fRec89"][1])) + (self._fConst430 * state["fRec89"][2])))))) 
		fVbargraph8 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec88"])))
		self.sow("intermediates", "fVbargraph8", fVbargraph8) 
		state["fRec95"] = state["fRec95"].at[0].set((fTemp41 - (self._fConst440 * ((self._fConst439 * state["fRec95"][2]) + (self._fConst438 * state["fRec95"][1]))))) 
		state["fRec94"] = state["fRec94"].at[0].set(((self._fConst440 * (((self._fConst442 * state["fRec95"][0]) + (self._fConst443 * state["fRec95"][1])) + (self._fConst442 * state["fRec95"][2]))) - (self._fConst437 * ((self._fConst436 * state["fRec94"][2]) + (self._fConst435 * state["fRec94"][1]))))) 
		state["fRec93"] = state["fRec93"].at[0].set(((self._fConst437 * (((self._fConst445 * state["fRec94"][0]) + (self._fConst446 * state["fRec94"][1])) + (self._fConst445 * state["fRec94"][2]))) - (self._fConst434 * ((self._fConst433 * state["fRec93"][2]) + (self._fConst432 * state["fRec93"][1]))))) 
		state["fRec92"] = ((fSlow108 * fRec92_temp) + (fSlow109 * jnp.abs((self._fConst434 * (((self._fConst448 * state["fRec93"][0]) + (self._fConst449 * state["fRec93"][1])) + (self._fConst448 * state["fRec93"][2])))))) 
		fVbargraph9 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec92"])))
		self.sow("intermediates", "fVbargraph9", fVbargraph9) 
		state["fRec99"] = state["fRec99"].at[0].set((fTemp40 - (self._fConst458 * ((self._fConst457 * state["fRec99"][2]) + (self._fConst456 * state["fRec99"][1]))))) 
		state["fRec98"] = state["fRec98"].at[0].set(((self._fConst458 * (((self._fConst460 * state["fRec99"][0]) + (self._fConst461 * state["fRec99"][1])) + (self._fConst460 * state["fRec99"][2]))) - (self._fConst455 * ((self._fConst454 * state["fRec98"][2]) + (self._fConst453 * state["fRec98"][1]))))) 
		state["fRec97"] = state["fRec97"].at[0].set(((self._fConst455 * (((self._fConst463 * state["fRec98"][0]) + (self._fConst464 * state["fRec98"][1])) + (self._fConst463 * state["fRec98"][2]))) - (self._fConst452 * ((self._fConst451 * state["fRec97"][2]) + (self._fConst450 * state["fRec97"][1]))))) 
		state["fRec96"] = ((fSlow108 * fRec96_temp) + (fSlow109 * jnp.abs((self._fConst452 * (((self._fConst466 * state["fRec97"][0]) + (self._fConst467 * state["fRec97"][1])) + (self._fConst466 * state["fRec97"][2])))))) 
		fVbargraph10 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec96"])))
		self.sow("intermediates", "fVbargraph10", fVbargraph10) 
		state["fRec103"] = state["fRec103"].at[0].set((fTemp39 - (self._fConst476 * ((self._fConst475 * state["fRec103"][2]) + (self._fConst474 * state["fRec103"][1]))))) 
		state["fRec102"] = state["fRec102"].at[0].set(((self._fConst476 * (((self._fConst478 * state["fRec103"][0]) + (self._fConst479 * state["fRec103"][1])) + (self._fConst478 * state["fRec103"][2]))) - (self._fConst473 * ((self._fConst472 * state["fRec102"][2]) + (self._fConst471 * state["fRec102"][1]))))) 
		state["fRec101"] = state["fRec101"].at[0].set(((self._fConst473 * (((self._fConst481 * state["fRec102"][0]) + (self._fConst482 * state["fRec102"][1])) + (self._fConst481 * state["fRec102"][2]))) - (self._fConst470 * ((self._fConst469 * state["fRec101"][2]) + (self._fConst468 * state["fRec101"][1]))))) 
		state["fRec100"] = ((fSlow108 * fRec100_temp) + (fSlow109 * jnp.abs((self._fConst470 * (((self._fConst484 * state["fRec101"][0]) + (self._fConst485 * state["fRec101"][1])) + (self._fConst484 * state["fRec101"][2])))))) 
		fVbargraph11 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec100"])))
		self.sow("intermediates", "fVbargraph11", fVbargraph11) 
		state["fRec107"] = state["fRec107"].at[0].set((fTemp38 - (self._fConst494 * ((self._fConst493 * state["fRec107"][2]) + (self._fConst492 * state["fRec107"][1]))))) 
		state["fRec106"] = state["fRec106"].at[0].set(((self._fConst494 * (((self._fConst496 * state["fRec107"][0]) + (self._fConst497 * state["fRec107"][1])) + (self._fConst496 * state["fRec107"][2]))) - (self._fConst491 * ((self._fConst490 * state["fRec106"][2]) + (self._fConst489 * state["fRec106"][1]))))) 
		state["fRec105"] = state["fRec105"].at[0].set(((self._fConst491 * (((self._fConst499 * state["fRec106"][0]) + (self._fConst500 * state["fRec106"][1])) + (self._fConst499 * state["fRec106"][2]))) - (self._fConst488 * ((self._fConst487 * state["fRec105"][2]) + (self._fConst486 * state["fRec105"][1]))))) 
		state["fRec104"] = ((fSlow108 * fRec104_temp) + (fSlow109 * jnp.abs((self._fConst488 * (((self._fConst502 * state["fRec105"][0]) + (self._fConst503 * state["fRec105"][1])) + (self._fConst502 * state["fRec105"][2])))))) 
		fVbargraph12 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec104"])))
		self.sow("intermediates", "fVbargraph12", fVbargraph12) 
		state["fRec111"] = state["fRec111"].at[0].set((fTemp37 - (self._fConst512 * ((self._fConst511 * state["fRec111"][2]) + (self._fConst510 * state["fRec111"][1]))))) 
		state["fRec110"] = state["fRec110"].at[0].set(((self._fConst512 * (((self._fConst514 * state["fRec111"][0]) + (self._fConst515 * state["fRec111"][1])) + (self._fConst514 * state["fRec111"][2]))) - (self._fConst509 * ((self._fConst508 * state["fRec110"][2]) + (self._fConst507 * state["fRec110"][1]))))) 
		state["fRec109"] = state["fRec109"].at[0].set(((self._fConst509 * (((self._fConst517 * state["fRec110"][0]) + (self._fConst518 * state["fRec110"][1])) + (self._fConst517 * state["fRec110"][2]))) - (self._fConst506 * ((self._fConst505 * state["fRec109"][2]) + (self._fConst504 * state["fRec109"][1]))))) 
		state["fRec108"] = ((fSlow108 * fRec108_temp) + (fSlow109 * jnp.abs((self._fConst506 * (((self._fConst520 * state["fRec109"][0]) + (self._fConst521 * state["fRec109"][1])) + (self._fConst520 * state["fRec109"][2])))))) 
		fVbargraph13 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec108"])))
		self.sow("intermediates", "fVbargraph13", fVbargraph13) 
		state["fRec115"] = state["fRec115"].at[0].set((fTemp36 - (self._fConst530 * ((self._fConst529 * state["fRec115"][2]) + (self._fConst528 * state["fRec115"][1]))))) 
		state["fRec114"] = state["fRec114"].at[0].set(((self._fConst530 * (((self._fConst532 * state["fRec115"][0]) + (self._fConst533 * state["fRec115"][1])) + (self._fConst532 * state["fRec115"][2]))) - (self._fConst527 * ((self._fConst526 * state["fRec114"][2]) + (self._fConst525 * state["fRec114"][1]))))) 
		state["fRec113"] = state["fRec113"].at[0].set(((self._fConst527 * (((self._fConst535 * state["fRec114"][0]) + (self._fConst536 * state["fRec114"][1])) + (self._fConst535 * state["fRec114"][2]))) - (self._fConst524 * ((self._fConst523 * state["fRec113"][2]) + (self._fConst522 * state["fRec113"][1]))))) 
		state["fRec112"] = ((fRec112_temp * fSlow108) + (jnp.abs((self._fConst524 * (((self._fConst538 * state["fRec113"][0]) + (self._fConst539 * state["fRec113"][1])) + (self._fConst538 * state["fRec113"][2])))) * fSlow109)) 
		fVbargraph14 = (fSlow110 + (jnp.float32(2e+01) * jnp.log10(state["fRec112"])))
