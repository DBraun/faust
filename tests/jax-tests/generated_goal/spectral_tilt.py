...
class mydsp(nnx.Module):
	...
	def __init__(
		...
		unnorm_funcs = {}
		ui_path = []
		ui_path.append("spectral_tilt") 
		ui_path.append("Spectral Tilt Filter") 
		self.add_hslider("fHslider4", ui_path, "Slope of Spectral Tilt across Band", -0.5, -1.0, 1.0, unnorm_funcs, "linear") 
		ui_path.append("Spectral Tilt Filter") 
		self.add_button("fCheckbox0", ui_path, "Bypass Spectral Tilt", unnorm_funcs) 
		ui_path.pop()
		self.add_hslider("fHslider2", ui_path, "Band Start Frequency", 1e+02, 2e+01, 1e+04, unnorm_funcs, "linear") 
		self.add_hslider("fHslider3", ui_path, "Band Width", 5e+03, 1e+02, 1e+04, unnorm_funcs, "linear") 
		ui_path.pop()
		ui_path.append("Test Signal") 
		...
		self.add_button("fCheckbox2", ui_path, "Noise (White or Pink - uses only Amplitude control on the left)", unnorm_funcs) 
		self.add_button("fCheckbox3", ui_path, "Pink instead of White Noise (also called 1/f Noise)", unnorm_funcs) 
		self.add_button("fCheckbox1", ui_path, "External Signal Input (overrides Sawtooth/Noise selection above)", unnorm_funcs) 
		ui_path.pop()
		ui_path.pop()
		ui_path.pop()
		ui_path.pop()
		ui_path.append("Spectrum Analyzer") 
		...
		self._fConst15 = (np.float32(1.0) / np.tan((np.float32(0.5) / self._fConst0))) 
		self._fConst16 = (np.float32(1.0) / self._fConst0) 
		self._fConst17 = (np.float32(0.25) * self._fConst0) 
		self._fConst18 = (np.float32(0.041666668) * np.power(self._fConst0, np.float32(2.0))) 
		self._fConst19 = (np.float32(0.0052083335) * np.power(self._fConst0, np.float32(3.0))) 
	...
	def _initialize_carry(self, x: jnp.ndarray, length: int):
		...
		state["fRec20"] = np.zeros((4,), dtype=np.float32)
	...
	def tick(self, params: dict, state: dict, inputs: jnp.ndarray, rng: jax.Array = None) -> Tuple[dict, jnp.ndarray]:
		...
		fSlow4 = params["fHslider2"] 
		fSlow5 = jnp.power(((fSlow4 + params["fHslider3"]) / fSlow4), jnp.float32(0.11111111)) 
		fSlow6 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(9.0))))) 
		fSlow7 = params["fHslider4"] 
		fSlow8 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(9.0) - fSlow7))))) 
		fSlow9 = (fSlow6 / fSlow8) 
		fSlow10 = jnp.tan((self._fConst14 * fSlow4)) 
		fSlow11 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow6) / fSlow10)) 
		fSlow12 = (jnp.float32(1.0) / (self._fConst15 + fSlow11)) 
		fSlow13 = (fSlow11 - self._fConst15) 
		fSlow14 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(8.0))))) 
		fSlow15 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow8) / fSlow10)) 
		fSlow16 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(8.0) - fSlow7))))) 
		fSlow17 = ((fSlow14 * (self._fConst15 + fSlow15)) / fSlow16) 
		fSlow18 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow14) / fSlow10)) 
		fSlow19 = (jnp.float32(1.0) / (self._fConst15 + fSlow18)) 
		fSlow20 = (fSlow18 - self._fConst15) 
		fSlow21 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(7.0))))) 
		fSlow22 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow16) / fSlow10)) 
		fSlow23 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(7.0) - fSlow7))))) 
		fSlow24 = ((fSlow21 * (self._fConst15 + fSlow22)) / fSlow23) 
		fSlow25 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow21) / fSlow10)) 
		fSlow26 = (jnp.float32(1.0) / (self._fConst15 + fSlow25)) 
		fSlow27 = (fSlow25 - self._fConst15) 
		fSlow28 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(6.0))))) 
		fSlow29 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow23) / fSlow10)) 
		fSlow30 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(6.0) - fSlow7))))) 
		fSlow31 = ((fSlow28 * (self._fConst15 + fSlow29)) / fSlow30) 
		fSlow32 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow28) / fSlow10)) 
		fSlow33 = (jnp.float32(1.0) / (self._fConst15 + fSlow32)) 
		fSlow34 = (fSlow32 - self._fConst15) 
		fSlow35 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(5.0))))) 
		fSlow36 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow30) / fSlow10)) 
		fSlow37 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(5.0) - fSlow7))))) 
		fSlow38 = ((fSlow35 * (self._fConst15 + fSlow36)) / fSlow37) 
		fSlow39 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow35) / fSlow10)) 
		fSlow40 = (jnp.float32(1.0) / (self._fConst15 + fSlow39)) 
		fSlow41 = (fSlow39 - self._fConst15) 
		fSlow42 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(4.0))))) 
		fSlow43 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow37) / fSlow10)) 
		fSlow44 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(4.0) - fSlow7))))) 
		fSlow45 = ((fSlow42 * (self._fConst15 + fSlow43)) / fSlow44) 
		fSlow46 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow42) / fSlow10)) 
		fSlow47 = (jnp.float32(1.0) / (self._fConst15 + fSlow46)) 
		fSlow48 = (fSlow46 - self._fConst15) 
		fSlow49 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(3.0))))) 
		fSlow50 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow44) / fSlow10)) 
		fSlow51 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(3.0) - fSlow7))))) 
		fSlow52 = ((fSlow49 * (self._fConst15 + fSlow50)) / fSlow51) 
		fSlow53 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow49) / fSlow10)) 
		fSlow54 = (jnp.float32(1.0) / (self._fConst15 + fSlow53)) 
		fSlow55 = (fSlow53 - self._fConst15) 
		fSlow56 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, jnp.float32(2.0))))) 
		fSlow57 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow51) / fSlow10)) 
		fSlow58 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(2.0) - fSlow7))))) 
		fSlow59 = ((fSlow56 * (self._fConst15 + fSlow57)) / fSlow58) 
		fSlow60 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow56) / fSlow10)) 
		fSlow61 = (jnp.float32(1.0) / (self._fConst15 + fSlow60)) 
		fSlow62 = (fSlow60 - self._fConst15) 
		fSlow63 = jnp.tan((self._fConst14 * (fSlow4 * fSlow5))) 
		fSlow64 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow58) / fSlow10)) 
		fSlow65 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, (jnp.float32(1.0) - fSlow7))))) 
		fSlow66 = ((fSlow63 * (self._fConst15 + fSlow64)) / fSlow65) 
		fSlow67 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow63) / fSlow10)) 
		fSlow68 = (jnp.float32(1.0) / (self._fConst15 + fSlow67)) 
		fSlow69 = (fSlow67 - self._fConst15) 
		fSlow70 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow65) / fSlow10)) 
		fSlow71 = jnp.tan((self._fConst14 * (fSlow4 * jnp.power(fSlow5, -fSlow7)))) 
		fSlow72 = ((fSlow10 * (self._fConst15 + fSlow70)) / fSlow71) 
		fSlow73 = (jnp.float32(6.2831855) * fSlow4) 
		fSlow74 = (jnp.float32(1.0) / (self._fConst15 + fSlow73)) 
		fSlow75 = (fSlow73 - self._fConst15) 
		fSlow76 = (jnp.float32(6.2831855) * ((fSlow4 * fSlow71) / fSlow10)) 
		fSlow77 = (self._fConst15 + fSlow76) 
		fSlow78 = (jnp.float32(0.001) * jnp.power(jnp.float32(1e+01), (jnp.float32(0.05) * params["fVslider0"]))) 
		iSlow79 = jnp.int32(params["fCheckbox1"]) 
		iSlow80 = jnp.int32(params["fCheckbox2"]) 
		iSlow81 = jnp.int32((params["fEntry0"] + jnp.float32(-1.0))) 
		iSlow82 = (iSlow81 >= jnp.int32(2)).astype(jnp.int32) 
		iSlow83 = (iSlow81 >= jnp.int32(1)).astype(jnp.int32) 
		fSlow84 = params["fVslider1"] 
		fSlow85 = jnp.where(((fSlow84 > jnp.float32(0.0)).astype(jnp.int32) != 0), jnp.exp(-((self._fConst16 / fSlow84))), jnp.float32(0.0)) 
		fSlow86 = ((jnp.float32(4.4e+02) * jnp.power(jnp.float32(2.0), (jnp.float32(0.083333336) * (params["fVslider2"] + jnp.float32(-49.0))))) * (jnp.float32(1.0) - fSlow85)) 
		iSlow87 = (iSlow81 >= jnp.int32(3)).astype(jnp.int32) 
		fSlow88 = ((jnp.float32(0.01) * params["fVslider3"]) + jnp.float32(1.0)) 
		fSlow89 = ((jnp.float32(0.01) * params["fVslider4"]) + jnp.float32(1.0)) 
		iSlow90 = jnp.int32(params["fCheckbox3"]) 
		fSlow91 = (fSlow76 - self._fConst15) 
		fSlow92 = (fSlow70 - self._fConst15) 
		fSlow93 = (fSlow10 / fSlow71) 
		fSlow94 = (fSlow64 - self._fConst15) 
		fSlow95 = (fSlow63 / fSlow65) 
		fSlow96 = (fSlow57 - self._fConst15) 
		fSlow97 = (fSlow56 / fSlow58) 
		fSlow98 = (fSlow50 - self._fConst15) 
		fSlow99 = (fSlow49 / fSlow51) 
		fSlow100 = (fSlow43 - self._fConst15) 
		fSlow101 = (fSlow42 / fSlow44) 
		fSlow102 = (fSlow36 - self._fConst15) 
		fSlow103 = (fSlow35 / fSlow37) 
		fSlow104 = (fSlow29 - self._fConst15) 
		fSlow105 = (fSlow28 / fSlow30) 
		fSlow106 = (fSlow22 - self._fConst15) 
		fSlow107 = (fSlow21 / fSlow23) 
		fSlow108 = (fSlow15 - self._fConst15) 
		fSlow109 = (fSlow14 / fSlow16) 
		fSlow110 = (jnp.float32(1.0) - fSlow2) 
		...
		state["fRec14"] = (fSlow78 + (jnp.float32(0.999) * fRec14_temp)) 
		state["iVec0"] = state["iVec0"].at[0].set(jnp.int32(1)) 
		state["fRec16"] = ((fRec16_temp * fSlow85) + fSlow86) 
		fTemp0 = jnp.maximum(jnp.float32(2e+01), jnp.abs(state["fRec16"])) 
		fTemp1 = (fRec15_temp + (self._fConst16 * fTemp0)) 
		state["fRec15"] = (fTemp1 - jnp.floor(fTemp1)) 
		fTemp2 = (jnp.float32(2.0) * state["fRec15"]) 
		...
		fTemp13 = jnp.maximum(jnp.float32(2e+01), jnp.abs((fSlow88 * state["fRec16"]))) 
		fTemp14 = (fRec17_temp + (self._fConst16 * fTemp13)) 
		state["fRec17"] = (fTemp14 - jnp.floor(fTemp14)) 
		fTemp15 = (jnp.float32(2.0) * state["fRec17"]) 
		...
		fTemp23 = jnp.maximum(jnp.float32(2e+01), jnp.abs((fSlow89 * state["fRec16"]))) 
		fTemp24 = (fRec18_temp + (self._fConst16 * fTemp23)) 
		state["fRec18"] = (fTemp24 - jnp.floor(fTemp24)) 
		fTemp25 = (jnp.float32(2.0) * state["fRec18"]) 
		...
		state["iRec19"] = ((jnp.int32(1103515245) * iRec19_temp) + jnp.int32(12345)) 
		fTemp33 = (jnp.float32(4.656613e-10) * (state["iRec19"])) 
		state["fRec20"] = state["fRec20"].at[0].set((((jnp.float32(0.5221894) * state["fRec20"][3]) + (fTemp33 + (jnp.float32(2.494956) * state["fRec20"][1]))) - (jnp.float32(2.0172658) * state["fRec20"][2]))) 
		fTemp34 = (state["fRec14"] * jnp.where((iSlow79 != 0), inputs[0], jnp.where((iSlow80 != 0), jnp.where((iSlow90 != 0), (((jnp.float32(0.049922034) * state["fRec20"][0]) + (jnp.float32(0.0506127) * state["fRec20"][2])) - ((jnp.float32(0.095993534) * state["fRec20"][1]) + (jnp.float32(0.004408786) * state["fRec20"][3]))), fTemp33), (jnp.float32(0.33333334) * (state["fRec14"] * ((jnp.where((iSlow82 != 0), jnp.where((iSlow87 != 0), (self._fConst19 * ((fTemp9 * (fTemp12 - fVec6_temp)) / fTemp0)), (self._fConst18 * ((fTemp6 * (fTemp8 - fVec3_temp)) / fTemp0))), jnp.where((iSlow83 != 0), (self._fConst17 * ((fTemp4 * (fTemp5 - fVec1_temp)) / fTemp0)), fTemp3)) + jnp.where((iSlow82 != 0), jnp.where((iSlow87 != 0), (self._fConst19 * ((fTemp9 * (fTemp22 - fVec12_temp)) / fTemp13)), (self._fConst18 * ((fTemp6 * (fTemp19 - fVec9_temp)) / fTemp13))), jnp.where((iSlow83 != 0), (self._fConst17 * ((fTemp4 * (fTemp17 - fVec7_temp)) / fTemp13)), fTemp16))) + jnp.where((iSlow82 != 0), jnp.where((iSlow87 != 0), (self._fConst19 * ((fTemp9 * (fTemp32 - fVec18_temp)) / fTemp23)), (self._fConst18 * ((fTemp6 * (fTemp29 - fVec15_temp)) / fTemp23))), jnp.where((iSlow83 != 0), (self._fConst17 * ((fTemp4 * (fTemp27 - fVec13_temp)) / fTemp23)), fTemp26)))))))) 
		fTemp35 = jnp.where((iSlow3 != 0), jnp.float32(0.0), fTemp34) 
		state["fVec19"] = jnp.float32(fTemp35) 
		state["fRec13"] = -((fSlow74 * ((fSlow75 * fRec13_temp) - ((fSlow77 * fTemp35) + (fSlow91 * fVec19_temp))))) 
		state["fVec20"] = (fSlow93 * state["fRec13"]) 
		state["fRec12"] = -((fSlow68 * ((fSlow69 * fRec12_temp) - ((fSlow72 * state["fRec13"]) + (fSlow92 * fVec20_temp))))) 
		state["fVec21"] = (fSlow95 * state["fRec12"]) 
		state["fRec11"] = -((fSlow61 * ((fSlow62 * fRec11_temp) - ((fSlow66 * state["fRec12"]) + (fSlow94 * fVec21_temp))))) 
		state["fVec22"] = (fSlow97 * state["fRec11"]) 
		state["fRec10"] = -((fSlow54 * ((fSlow55 * fRec10_temp) - ((fSlow59 * state["fRec11"]) + (fSlow96 * fVec22_temp))))) 
		state["fVec23"] = (fSlow99 * state["fRec10"]) 
		state["fRec9"] = -((fSlow47 * ((fSlow48 * fRec9_temp) - ((fSlow52 * state["fRec10"]) + (fSlow98 * fVec23_temp))))) 
		state["fVec24"] = (fSlow101 * state["fRec9"]) 
		state["fRec8"] = -((fSlow40 * ((fSlow41 * fRec8_temp) - ((fSlow45 * state["fRec9"]) + (fSlow100 * fVec24_temp))))) 
		state["fVec25"] = (fSlow103 * state["fRec8"]) 
		state["fRec7"] = -((fSlow33 * ((fSlow34 * fRec7_temp) - ((fSlow38 * state["fRec8"]) + (fSlow102 * fVec25_temp))))) 
		state["fVec26"] = (fSlow105 * state["fRec7"]) 
		state["fRec6"] = -((fSlow26 * ((fSlow27 * fRec6_temp) - ((fSlow31 * state["fRec7"]) + (fSlow104 * fVec26_temp))))) 
		state["fVec27"] = (fSlow107 * state["fRec6"]) 
		state["fRec5"] = -((fSlow19 * ((fSlow20 * fRec5_temp) - ((fSlow24 * state["fRec6"]) + (fSlow106 * fVec27_temp))))) 
		state["fVec28"] = (fSlow109 * state["fRec5"]) 
		state["fRec4"] = -((fSlow12 * ((fSlow13 * fRec4_temp) - ((fSlow17 * state["fRec5"]) + (fSlow108 * fVec28_temp))))) 
		fTemp36 = jnp.where((iSlow3 != 0), fTemp34, (fSlow9 * state["fRec4"])) 
		state["fRec3"] = state["fRec3"].at[0].set((fTemp36 - (self._fConst11 * ((self._fConst20 * state["fRec3"][2]) + (self._fConst22 * state["fRec3"][1]))))) 
		...
		state["fRec0"] = ((fRec0_temp * fSlow2) + (jnp.abs((self._fConst4 * (((self._fConst7 * state["fRec1"][0]) + (self._fConst29 * state["fRec1"][1])) + (self._fConst7 * state["fRec1"][2])))) * fSlow110)) 
		fVbargraph0 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec0"])))
		# self.sow("intermediates", "fVbargraph0", fVbargraph0) 
		state["fRec27"] = state["fRec27"].at[0].set((fTemp36 - (self._fConst46 * ((self._fConst49 * state["fRec27"][2]) + (self._fConst50 * state["fRec27"][1]))))) 
		state["fRec26"] = state["fRec26"].at[0].set(((self._fConst46 * (((self._fConst48 * state["fRec27"][0]) + (self._fConst51 * state["fRec27"][1])) + (self._fConst48 * state["fRec27"][2]))) - (self._fConst44 * ((self._fConst52 * state["fRec26"][2]) + (self._fConst53 * state["fRec26"][1]))))) 
		state["fRec25"] = state["fRec25"].at[0].set(((self._fConst44 * (((self._fConst45 * state["fRec26"][0]) + (self._fConst54 * state["fRec26"][1])) + (self._fConst45 * state["fRec26"][2]))) - (self._fConst42 * ((self._fConst55 * state["fRec25"][2]) + (self._fConst56 * state["fRec25"][1]))))) 
		fTemp37 = (self._fConst42 * (((self._fConst43 * state["fRec25"][0]) + (self._fConst57 * state["fRec25"][1])) + (self._fConst43 * state["fRec25"][2]))) 
		state["fRec24"] = state["fRec24"].at[0].set((fTemp37 - (self._fConst39 * ((self._fConst58 * state["fRec24"][2]) + (self._fConst60 * state["fRec24"][1]))))) 
		state["fRec23"] = state["fRec23"].at[0].set(((self._fConst39 * (((self._fConst41 * state["fRec24"][0]) + (self._fConst61 * state["fRec24"][1])) + (self._fConst41 * state["fRec24"][2]))) - (self._fConst36 * ((self._fConst62 * state["fRec23"][2]) + (self._fConst63 * state["fRec23"][1]))))) 
		state["fRec22"] = state["fRec22"].at[0].set(((self._fConst36 * (((self._fConst38 * state["fRec23"][0]) + (self._fConst64 * state["fRec23"][1])) + (self._fConst38 * state["fRec23"][2]))) - (self._fConst32 * ((self._fConst65 * state["fRec22"][2]) + (self._fConst66 * state["fRec22"][1]))))) 
		state["fRec21"] = ((fSlow2 * fRec21_temp) + (fSlow110 * jnp.abs((self._fConst32 * (((self._fConst35 * state["fRec22"][0]) + (self._fConst67 * state["fRec22"][1])) + (self._fConst35 * state["fRec22"][2])))))) 
		fVbargraph1 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec21"])))
		# self.sow("intermediates", "fVbargraph1", fVbargraph1) 
		state["fRec34"] = state["fRec34"].at[0].set((fTemp37 - (self._fConst84 * ((self._fConst87 * state["fRec34"][2]) + (self._fConst88 * state["fRec34"][1]))))) 
		state["fRec33"] = state["fRec33"].at[0].set(((self._fConst84 * (((self._fConst86 * state["fRec34"][0]) + (self._fConst89 * state["fRec34"][1])) + (self._fConst86 * state["fRec34"][2]))) - (self._fConst82 * ((self._fConst90 * state["fRec33"][2]) + (self._fConst91 * state["fRec33"][1]))))) 
		state["fRec32"] = state["fRec32"].at[0].set(((self._fConst82 * (((self._fConst83 * state["fRec33"][0]) + (self._fConst92 * state["fRec33"][1])) + (self._fConst83 * state["fRec33"][2]))) - (self._fConst80 * ((self._fConst93 * state["fRec32"][2]) + (self._fConst94 * state["fRec32"][1]))))) 
		fTemp38 = (self._fConst80 * (((self._fConst81 * state["fRec32"][0]) + (self._fConst95 * state["fRec32"][1])) + (self._fConst81 * state["fRec32"][2]))) 
		state["fRec31"] = state["fRec31"].at[0].set((fTemp38 - (self._fConst77 * ((self._fConst96 * state["fRec31"][2]) + (self._fConst98 * state["fRec31"][1]))))) 
		state["fRec30"] = state["fRec30"].at[0].set(((self._fConst77 * (((self._fConst79 * state["fRec31"][0]) + (self._fConst99 * state["fRec31"][1])) + (self._fConst79 * state["fRec31"][2]))) - (self._fConst74 * ((self._fConst100 * state["fRec30"][2]) + (self._fConst101 * state["fRec30"][1]))))) 
		state["fRec29"] = state["fRec29"].at[0].set(((self._fConst74 * (((self._fConst76 * state["fRec30"][0]) + (self._fConst102 * state["fRec30"][1])) + (self._fConst76 * state["fRec30"][2]))) - (self._fConst70 * ((self._fConst103 * state["fRec29"][2]) + (self._fConst104 * state["fRec29"][1]))))) 
		state["fRec28"] = ((fSlow2 * fRec28_temp) + (fSlow110 * jnp.abs((self._fConst70 * (((self._fConst73 * state["fRec29"][0]) + (self._fConst105 * state["fRec29"][1])) + (self._fConst73 * state["fRec29"][2])))))) 
		fVbargraph2 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec28"])))
		# self.sow("intermediates", "fVbargraph2", fVbargraph2) 
		state["fRec41"] = state["fRec41"].at[0].set((fTemp38 - (self._fConst122 * ((self._fConst125 * state["fRec41"][2]) + (self._fConst126 * state["fRec41"][1]))))) 
		state["fRec40"] = state["fRec40"].at[0].set(((self._fConst122 * (((self._fConst124 * state["fRec41"][0]) + (self._fConst127 * state["fRec41"][1])) + (self._fConst124 * state["fRec41"][2]))) - (self._fConst120 * ((self._fConst128 * state["fRec40"][2]) + (self._fConst129 * state["fRec40"][1]))))) 
		state["fRec39"] = state["fRec39"].at[0].set(((self._fConst120 * (((self._fConst121 * state["fRec40"][0]) + (self._fConst130 * state["fRec40"][1])) + (self._fConst121 * state["fRec40"][2]))) - (self._fConst118 * ((self._fConst131 * state["fRec39"][2]) + (self._fConst132 * state["fRec39"][1]))))) 
		fTemp39 = (self._fConst118 * (((self._fConst119 * state["fRec39"][0]) + (self._fConst133 * state["fRec39"][1])) + (self._fConst119 * state["fRec39"][2]))) 
		state["fRec38"] = state["fRec38"].at[0].set((fTemp39 - (self._fConst115 * ((self._fConst134 * state["fRec38"][2]) + (self._fConst136 * state["fRec38"][1]))))) 
		state["fRec37"] = state["fRec37"].at[0].set(((self._fConst115 * (((self._fConst117 * state["fRec38"][0]) + (self._fConst137 * state["fRec38"][1])) + (self._fConst117 * state["fRec38"][2]))) - (self._fConst112 * ((self._fConst138 * state["fRec37"][2]) + (self._fConst139 * state["fRec37"][1]))))) 
		state["fRec36"] = state["fRec36"].at[0].set(((self._fConst112 * (((self._fConst114 * state["fRec37"][0]) + (self._fConst140 * state["fRec37"][1])) + (self._fConst114 * state["fRec37"][2]))) - (self._fConst108 * ((self._fConst141 * state["fRec36"][2]) + (self._fConst142 * state["fRec36"][1]))))) 
		state["fRec35"] = ((fSlow2 * fRec35_temp) + (fSlow110 * jnp.abs((self._fConst108 * (((self._fConst111 * state["fRec36"][0]) + (self._fConst143 * state["fRec36"][1])) + (self._fConst111 * state["fRec36"][2])))))) 
		fVbargraph3 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec35"])))
		# self.sow("intermediates", "fVbargraph3", fVbargraph3) 
		state["fRec48"] = state["fRec48"].at[0].set((fTemp39 - (self._fConst160 * ((self._fConst163 * state["fRec48"][2]) + (self._fConst164 * state["fRec48"][1]))))) 
		state["fRec47"] = state["fRec47"].at[0].set(((self._fConst160 * (((self._fConst162 * state["fRec48"][0]) + (self._fConst165 * state["fRec48"][1])) + (self._fConst162 * state["fRec48"][2]))) - (self._fConst158 * ((self._fConst166 * state["fRec47"][2]) + (self._fConst167 * state["fRec47"][1]))))) 
		state["fRec46"] = state["fRec46"].at[0].set(((self._fConst158 * (((self._fConst159 * state["fRec47"][0]) + (self._fConst168 * state["fRec47"][1])) + (self._fConst159 * state["fRec47"][2]))) - (self._fConst156 * ((self._fConst169 * state["fRec46"][2]) + (self._fConst170 * state["fRec46"][1]))))) 
		fTemp40 = (self._fConst156 * (((self._fConst157 * state["fRec46"][0]) + (self._fConst171 * state["fRec46"][1])) + (self._fConst157 * state["fRec46"][2]))) 
		state["fRec45"] = state["fRec45"].at[0].set((fTemp40 - (self._fConst153 * ((self._fConst172 * state["fRec45"][2]) + (self._fConst174 * state["fRec45"][1]))))) 
		state["fRec44"] = state["fRec44"].at[0].set(((self._fConst153 * (((self._fConst155 * state["fRec45"][0]) + (self._fConst175 * state["fRec45"][1])) + (self._fConst155 * state["fRec45"][2]))) - (self._fConst150 * ((self._fConst176 * state["fRec44"][2]) + (self._fConst177 * state["fRec44"][1]))))) 
		state["fRec43"] = state["fRec43"].at[0].set(((self._fConst150 * (((self._fConst152 * state["fRec44"][0]) + (self._fConst178 * state["fRec44"][1])) + (self._fConst152 * state["fRec44"][2]))) - (self._fConst146 * ((self._fConst179 * state["fRec43"][2]) + (self._fConst180 * state["fRec43"][1]))))) 
		state["fRec42"] = ((fSlow2 * fRec42_temp) + (fSlow110 * jnp.abs((self._fConst146 * (((self._fConst149 * state["fRec43"][0]) + (self._fConst181 * state["fRec43"][1])) + (self._fConst149 * state["fRec43"][2])))))) 
		fVbargraph4 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec42"])))
		# self.sow("intermediates", "fVbargraph4", fVbargraph4) 
		state["fRec55"] = state["fRec55"].at[0].set((fTemp40 - (self._fConst198 * ((self._fConst201 * state["fRec55"][2]) + (self._fConst202 * state["fRec55"][1]))))) 
		state["fRec54"] = state["fRec54"].at[0].set(((self._fConst198 * (((self._fConst200 * state["fRec55"][0]) + (self._fConst203 * state["fRec55"][1])) + (self._fConst200 * state["fRec55"][2]))) - (self._fConst196 * ((self._fConst204 * state["fRec54"][2]) + (self._fConst205 * state["fRec54"][1]))))) 
		state["fRec53"] = state["fRec53"].at[0].set(((self._fConst196 * (((self._fConst197 * state["fRec54"][0]) + (self._fConst206 * state["fRec54"][1])) + (self._fConst197 * state["fRec54"][2]))) - (self._fConst194 * ((self._fConst207 * state["fRec53"][2]) + (self._fConst208 * state["fRec53"][1]))))) 
		fTemp41 = (self._fConst194 * (((self._fConst195 * state["fRec53"][0]) + (self._fConst209 * state["fRec53"][1])) + (self._fConst195 * state["fRec53"][2]))) 
		state["fRec52"] = state["fRec52"].at[0].set((fTemp41 - (self._fConst191 * ((self._fConst210 * state["fRec52"][2]) + (self._fConst212 * state["fRec52"][1]))))) 
		state["fRec51"] = state["fRec51"].at[0].set(((self._fConst191 * (((self._fConst193 * state["fRec52"][0]) + (self._fConst213 * state["fRec52"][1])) + (self._fConst193 * state["fRec52"][2]))) - (self._fConst188 * ((self._fConst214 * state["fRec51"][2]) + (self._fConst215 * state["fRec51"][1]))))) 
		state["fRec50"] = state["fRec50"].at[0].set(((self._fConst188 * (((self._fConst190 * state["fRec51"][0]) + (self._fConst216 * state["fRec51"][1])) + (self._fConst190 * state["fRec51"][2]))) - (self._fConst184 * ((self._fConst217 * state["fRec50"][2]) + (self._fConst218 * state["fRec50"][1]))))) 
		state["fRec49"] = ((fSlow2 * fRec49_temp) + (fSlow110 * jnp.abs((self._fConst184 * (((self._fConst187 * state["fRec50"][0]) + (self._fConst219 * state["fRec50"][1])) + (self._fConst187 * state["fRec50"][2])))))) 
		fVbargraph5 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec49"])))
		# self.sow("intermediates", "fVbargraph5", fVbargraph5) 
		state["fRec62"] = state["fRec62"].at[0].set((fTemp41 - (self._fConst236 * ((self._fConst239 * state["fRec62"][2]) + (self._fConst240 * state["fRec62"][1]))))) 
		state["fRec61"] = state["fRec61"].at[0].set(((self._fConst236 * (((self._fConst238 * state["fRec62"][0]) + (self._fConst241 * state["fRec62"][1])) + (self._fConst238 * state["fRec62"][2]))) - (self._fConst234 * ((self._fConst242 * state["fRec61"][2]) + (self._fConst243 * state["fRec61"][1]))))) 
		state["fRec60"] = state["fRec60"].at[0].set(((self._fConst234 * (((self._fConst235 * state["fRec61"][0]) + (self._fConst244 * state["fRec61"][1])) + (self._fConst235 * state["fRec61"][2]))) - (self._fConst232 * ((self._fConst245 * state["fRec60"][2]) + (self._fConst246 * state["fRec60"][1]))))) 
		fTemp42 = (self._fConst232 * (((self._fConst233 * state["fRec60"][0]) + (self._fConst247 * state["fRec60"][1])) + (self._fConst233 * state["fRec60"][2]))) 
		state["fRec59"] = state["fRec59"].at[0].set((fTemp42 - (self._fConst229 * ((self._fConst248 * state["fRec59"][2]) + (self._fConst250 * state["fRec59"][1]))))) 
		state["fRec58"] = state["fRec58"].at[0].set(((self._fConst229 * (((self._fConst231 * state["fRec59"][0]) + (self._fConst251 * state["fRec59"][1])) + (self._fConst231 * state["fRec59"][2]))) - (self._fConst226 * ((self._fConst252 * state["fRec58"][2]) + (self._fConst253 * state["fRec58"][1]))))) 
		state["fRec57"] = state["fRec57"].at[0].set(((self._fConst226 * (((self._fConst228 * state["fRec58"][0]) + (self._fConst254 * state["fRec58"][1])) + (self._fConst228 * state["fRec58"][2]))) - (self._fConst222 * ((self._fConst255 * state["fRec57"][2]) + (self._fConst256 * state["fRec57"][1]))))) 
		state["fRec56"] = ((fSlow2 * fRec56_temp) + (fSlow110 * jnp.abs((self._fConst222 * (((self._fConst225 * state["fRec57"][0]) + (self._fConst257 * state["fRec57"][1])) + (self._fConst225 * state["fRec57"][2])))))) 
		fVbargraph6 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec56"])))
		# self.sow("intermediates", "fVbargraph6", fVbargraph6) 
		state["fRec69"] = state["fRec69"].at[0].set((fTemp42 - (self._fConst274 * ((self._fConst277 * state["fRec69"][2]) + (self._fConst278 * state["fRec69"][1]))))) 
		state["fRec68"] = state["fRec68"].at[0].set(((self._fConst274 * (((self._fConst276 * state["fRec69"][0]) + (self._fConst279 * state["fRec69"][1])) + (self._fConst276 * state["fRec69"][2]))) - (self._fConst272 * ((self._fConst280 * state["fRec68"][2]) + (self._fConst281 * state["fRec68"][1]))))) 
		state["fRec67"] = state["fRec67"].at[0].set(((self._fConst272 * (((self._fConst273 * state["fRec68"][0]) + (self._fConst282 * state["fRec68"][1])) + (self._fConst273 * state["fRec68"][2]))) - (self._fConst270 * ((self._fConst283 * state["fRec67"][2]) + (self._fConst284 * state["fRec67"][1]))))) 
		fTemp43 = (self._fConst270 * (((self._fConst271 * state["fRec67"][0]) + (self._fConst285 * state["fRec67"][1])) + (self._fConst271 * state["fRec67"][2]))) 
		state["fRec66"] = state["fRec66"].at[0].set((fTemp43 - (self._fConst267 * ((self._fConst286 * state["fRec66"][2]) + (self._fConst288 * state["fRec66"][1]))))) 
		state["fRec65"] = state["fRec65"].at[0].set(((self._fConst267 * (((self._fConst269 * state["fRec66"][0]) + (self._fConst289 * state["fRec66"][1])) + (self._fConst269 * state["fRec66"][2]))) - (self._fConst264 * ((self._fConst290 * state["fRec65"][2]) + (self._fConst291 * state["fRec65"][1]))))) 
		state["fRec64"] = state["fRec64"].at[0].set(((self._fConst264 * (((self._fConst266 * state["fRec65"][0]) + (self._fConst292 * state["fRec65"][1])) + (self._fConst266 * state["fRec65"][2]))) - (self._fConst260 * ((self._fConst293 * state["fRec64"][2]) + (self._fConst294 * state["fRec64"][1]))))) 
		state["fRec63"] = ((fSlow2 * fRec63_temp) + (fSlow110 * jnp.abs((self._fConst260 * (((self._fConst263 * state["fRec64"][0]) + (self._fConst295 * state["fRec64"][1])) + (self._fConst263 * state["fRec64"][2])))))) 
		fVbargraph7 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec63"])))
		# self.sow("intermediates", "fVbargraph7", fVbargraph7) 
		state["fRec76"] = state["fRec76"].at[0].set((fTemp43 - (self._fConst312 * ((self._fConst315 * state["fRec76"][2]) + (self._fConst316 * state["fRec76"][1]))))) 
		state["fRec75"] = state["fRec75"].at[0].set(((self._fConst312 * (((self._fConst314 * state["fRec76"][0]) + (self._fConst317 * state["fRec76"][1])) + (self._fConst314 * state["fRec76"][2]))) - (self._fConst310 * ((self._fConst318 * state["fRec75"][2]) + (self._fConst319 * state["fRec75"][1]))))) 
		state["fRec74"] = state["fRec74"].at[0].set(((self._fConst310 * (((self._fConst311 * state["fRec75"][0]) + (self._fConst320 * state["fRec75"][1])) + (self._fConst311 * state["fRec75"][2]))) - (self._fConst308 * ((self._fConst321 * state["fRec74"][2]) + (self._fConst322 * state["fRec74"][1]))))) 
		fTemp44 = (self._fConst308 * (((self._fConst309 * state["fRec74"][0]) + (self._fConst323 * state["fRec74"][1])) + (self._fConst309 * state["fRec74"][2]))) 
		state["fRec73"] = state["fRec73"].at[0].set((fTemp44 - (self._fConst305 * ((self._fConst324 * state["fRec73"][2]) + (self._fConst326 * state["fRec73"][1]))))) 
		state["fRec72"] = state["fRec72"].at[0].set(((self._fConst305 * (((self._fConst307 * state["fRec73"][0]) + (self._fConst327 * state["fRec73"][1])) + (self._fConst307 * state["fRec73"][2]))) - (self._fConst302 * ((self._fConst328 * state["fRec72"][2]) + (self._fConst329 * state["fRec72"][1]))))) 
		state["fRec71"] = state["fRec71"].at[0].set(((self._fConst302 * (((self._fConst304 * state["fRec72"][0]) + (self._fConst330 * state["fRec72"][1])) + (self._fConst304 * state["fRec72"][2]))) - (self._fConst298 * ((self._fConst331 * state["fRec71"][2]) + (self._fConst332 * state["fRec71"][1]))))) 
		state["fRec70"] = ((fSlow2 * fRec70_temp) + (fSlow110 * jnp.abs((self._fConst298 * (((self._fConst301 * state["fRec71"][0]) + (self._fConst333 * state["fRec71"][1])) + (self._fConst301 * state["fRec71"][2])))))) 
		fVbargraph8 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec70"])))
		# self.sow("intermediates", "fVbargraph8", fVbargraph8) 
		state["fRec83"] = state["fRec83"].at[0].set((fTemp44 - (self._fConst350 * ((self._fConst353 * state["fRec83"][2]) + (self._fConst354 * state["fRec83"][1]))))) 
		state["fRec82"] = state["fRec82"].at[0].set(((self._fConst350 * (((self._fConst352 * state["fRec83"][0]) + (self._fConst355 * state["fRec83"][1])) + (self._fConst352 * state["fRec83"][2]))) - (self._fConst348 * ((self._fConst356 * state["fRec82"][2]) + (self._fConst357 * state["fRec82"][1]))))) 
		state["fRec81"] = state["fRec81"].at[0].set(((self._fConst348 * (((self._fConst349 * state["fRec82"][0]) + (self._fConst358 * state["fRec82"][1])) + (self._fConst349 * state["fRec82"][2]))) - (self._fConst346 * ((self._fConst359 * state["fRec81"][2]) + (self._fConst360 * state["fRec81"][1]))))) 
		fTemp45 = (self._fConst346 * (((self._fConst347 * state["fRec81"][0]) + (self._fConst361 * state["fRec81"][1])) + (self._fConst347 * state["fRec81"][2]))) 
		state["fRec80"] = state["fRec80"].at[0].set((fTemp45 - (self._fConst343 * ((self._fConst362 * state["fRec80"][2]) + (self._fConst364 * state["fRec80"][1]))))) 
		state["fRec79"] = state["fRec79"].at[0].set(((self._fConst343 * (((self._fConst345 * state["fRec80"][0]) + (self._fConst365 * state["fRec80"][1])) + (self._fConst345 * state["fRec80"][2]))) - (self._fConst340 * ((self._fConst366 * state["fRec79"][2]) + (self._fConst367 * state["fRec79"][1]))))) 
		state["fRec78"] = state["fRec78"].at[0].set(((self._fConst340 * (((self._fConst342 * state["fRec79"][0]) + (self._fConst368 * state["fRec79"][1])) + (self._fConst342 * state["fRec79"][2]))) - (self._fConst336 * ((self._fConst369 * state["fRec78"][2]) + (self._fConst370 * state["fRec78"][1]))))) 
		state["fRec77"] = ((fSlow2 * fRec77_temp) + (fSlow110 * jnp.abs((self._fConst336 * (((self._fConst339 * state["fRec78"][0]) + (self._fConst371 * state["fRec78"][1])) + (self._fConst339 * state["fRec78"][2])))))) 
		fVbargraph9 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec77"])))
		# self.sow("intermediates", "fVbargraph9", fVbargraph9) 
		state["fRec90"] = state["fRec90"].at[0].set((fTemp45 - (self._fConst388 * ((self._fConst391 * state["fRec90"][2]) + (self._fConst392 * state["fRec90"][1]))))) 
		state["fRec89"] = state["fRec89"].at[0].set(((self._fConst388 * (((self._fConst390 * state["fRec90"][0]) + (self._fConst393 * state["fRec90"][1])) + (self._fConst390 * state["fRec90"][2]))) - (self._fConst386 * ((self._fConst394 * state["fRec89"][2]) + (self._fConst395 * state["fRec89"][1]))))) 
		state["fRec88"] = state["fRec88"].at[0].set(((self._fConst386 * (((self._fConst387 * state["fRec89"][0]) + (self._fConst396 * state["fRec89"][1])) + (self._fConst387 * state["fRec89"][2]))) - (self._fConst384 * ((self._fConst397 * state["fRec88"][2]) + (self._fConst398 * state["fRec88"][1]))))) 
		fTemp46 = (self._fConst384 * (((self._fConst385 * state["fRec88"][0]) + (self._fConst399 * state["fRec88"][1])) + (self._fConst385 * state["fRec88"][2]))) 
		state["fRec87"] = state["fRec87"].at[0].set((fTemp46 - (self._fConst381 * ((self._fConst400 * state["fRec87"][2]) + (self._fConst402 * state["fRec87"][1]))))) 
		state["fRec86"] = state["fRec86"].at[0].set(((self._fConst381 * (((self._fConst383 * state["fRec87"][0]) + (self._fConst403 * state["fRec87"][1])) + (self._fConst383 * state["fRec87"][2]))) - (self._fConst378 * ((self._fConst404 * state["fRec86"][2]) + (self._fConst405 * state["fRec86"][1]))))) 
		state["fRec85"] = state["fRec85"].at[0].set(((self._fConst378 * (((self._fConst380 * state["fRec86"][0]) + (self._fConst406 * state["fRec86"][1])) + (self._fConst380 * state["fRec86"][2]))) - (self._fConst374 * ((self._fConst407 * state["fRec85"][2]) + (self._fConst408 * state["fRec85"][1]))))) 
		state["fRec84"] = ((fSlow2 * fRec84_temp) + (fSlow110 * jnp.abs((self._fConst374 * (((self._fConst377 * state["fRec85"][0]) + (self._fConst409 * state["fRec85"][1])) + (self._fConst377 * state["fRec85"][2])))))) 
		fVbargraph10 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec84"])))
		# self.sow("intermediates", "fVbargraph10", fVbargraph10) 
		state["fRec97"] = state["fRec97"].at[0].set((fTemp46 - (self._fConst426 * ((self._fConst429 * state["fRec97"][2]) + (self._fConst430 * state["fRec97"][1]))))) 
		state["fRec96"] = state["fRec96"].at[0].set(((self._fConst426 * (((self._fConst428 * state["fRec97"][0]) + (self._fConst431 * state["fRec97"][1])) + (self._fConst428 * state["fRec97"][2]))) - (self._fConst424 * ((self._fConst432 * state["fRec96"][2]) + (self._fConst433 * state["fRec96"][1]))))) 
		state["fRec95"] = state["fRec95"].at[0].set(((self._fConst424 * (((self._fConst425 * state["fRec96"][0]) + (self._fConst434 * state["fRec96"][1])) + (self._fConst425 * state["fRec96"][2]))) - (self._fConst422 * ((self._fConst435 * state["fRec95"][2]) + (self._fConst436 * state["fRec95"][1]))))) 
		fTemp47 = (self._fConst422 * (((self._fConst423 * state["fRec95"][0]) + (self._fConst437 * state["fRec95"][1])) + (self._fConst423 * state["fRec95"][2]))) 
		state["fRec94"] = state["fRec94"].at[0].set((fTemp47 - (self._fConst419 * ((self._fConst438 * state["fRec94"][2]) + (self._fConst440 * state["fRec94"][1]))))) 
		state["fRec93"] = state["fRec93"].at[0].set(((self._fConst419 * (((self._fConst421 * state["fRec94"][0]) + (self._fConst441 * state["fRec94"][1])) + (self._fConst421 * state["fRec94"][2]))) - (self._fConst416 * ((self._fConst442 * state["fRec93"][2]) + (self._fConst443 * state["fRec93"][1]))))) 
		state["fRec92"] = state["fRec92"].at[0].set(((self._fConst416 * (((self._fConst418 * state["fRec93"][0]) + (self._fConst444 * state["fRec93"][1])) + (self._fConst418 * state["fRec93"][2]))) - (self._fConst412 * ((self._fConst445 * state["fRec92"][2]) + (self._fConst446 * state["fRec92"][1]))))) 
		state["fRec91"] = ((fSlow2 * fRec91_temp) + (fSlow110 * jnp.abs((self._fConst412 * (((self._fConst415 * state["fRec92"][0]) + (self._fConst447 * state["fRec92"][1])) + (self._fConst415 * state["fRec92"][2])))))) 
		fVbargraph11 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec91"])))
		# self.sow("intermediates", "fVbargraph11", fVbargraph11) 
		state["fRec104"] = state["fRec104"].at[0].set((fTemp47 - (self._fConst464 * ((self._fConst467 * state["fRec104"][2]) + (self._fConst468 * state["fRec104"][1]))))) 
		state["fRec103"] = state["fRec103"].at[0].set(((self._fConst464 * (((self._fConst466 * state["fRec104"][0]) + (self._fConst469 * state["fRec104"][1])) + (self._fConst466 * state["fRec104"][2]))) - (self._fConst462 * ((self._fConst470 * state["fRec103"][2]) + (self._fConst471 * state["fRec103"][1]))))) 
		state["fRec102"] = state["fRec102"].at[0].set(((self._fConst462 * (((self._fConst463 * state["fRec103"][0]) + (self._fConst472 * state["fRec103"][1])) + (self._fConst463 * state["fRec103"][2]))) - (self._fConst460 * ((self._fConst473 * state["fRec102"][2]) + (self._fConst474 * state["fRec102"][1]))))) 
		fTemp48 = (self._fConst460 * (((self._fConst461 * state["fRec102"][0]) + (self._fConst475 * state["fRec102"][1])) + (self._fConst461 * state["fRec102"][2]))) 
		state["fRec101"] = state["fRec101"].at[0].set((fTemp48 - (self._fConst457 * ((self._fConst476 * state["fRec101"][2]) + (self._fConst478 * state["fRec101"][1]))))) 
		state["fRec100"] = state["fRec100"].at[0].set(((self._fConst457 * (((self._fConst459 * state["fRec101"][0]) + (self._fConst479 * state["fRec101"][1])) + (self._fConst459 * state["fRec101"][2]))) - (self._fConst454 * ((self._fConst480 * state["fRec100"][2]) + (self._fConst481 * state["fRec100"][1]))))) 
		state["fRec99"] = state["fRec99"].at[0].set(((self._fConst454 * (((self._fConst456 * state["fRec100"][0]) + (self._fConst482 * state["fRec100"][1])) + (self._fConst456 * state["fRec100"][2]))) - (self._fConst450 * ((self._fConst483 * state["fRec99"][2]) + (self._fConst484 * state["fRec99"][1]))))) 
		state["fRec98"] = ((fSlow2 * fRec98_temp) + (fSlow110 * jnp.abs((self._fConst450 * (((self._fConst453 * state["fRec99"][0]) + (self._fConst485 * state["fRec99"][1])) + (self._fConst453 * state["fRec99"][2])))))) 
		fVbargraph12 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec98"])))
		# self.sow("intermediates", "fVbargraph12", fVbargraph12) 
		state["fRec111"] = state["fRec111"].at[0].set((fTemp48 - (self._fConst502 * ((self._fConst505 * state["fRec111"][2]) + (self._fConst506 * state["fRec111"][1]))))) 
		state["fRec110"] = state["fRec110"].at[0].set(((self._fConst502 * (((self._fConst504 * state["fRec111"][0]) + (self._fConst507 * state["fRec111"][1])) + (self._fConst504 * state["fRec111"][2]))) - (self._fConst500 * ((self._fConst508 * state["fRec110"][2]) + (self._fConst509 * state["fRec110"][1]))))) 
		state["fRec109"] = state["fRec109"].at[0].set(((self._fConst500 * (((self._fConst501 * state["fRec110"][0]) + (self._fConst510 * state["fRec110"][1])) + (self._fConst501 * state["fRec110"][2]))) - (self._fConst498 * ((self._fConst511 * state["fRec109"][2]) + (self._fConst512 * state["fRec109"][1]))))) 
		fTemp49 = (self._fConst498 * (((self._fConst499 * state["fRec109"][0]) + (self._fConst513 * state["fRec109"][1])) + (self._fConst499 * state["fRec109"][2]))) 
		state["fRec108"] = state["fRec108"].at[0].set((fTemp49 - (self._fConst495 * ((self._fConst514 * state["fRec108"][2]) + (self._fConst516 * state["fRec108"][1]))))) 
		state["fRec107"] = state["fRec107"].at[0].set(((self._fConst495 * (((self._fConst497 * state["fRec108"][0]) + (self._fConst517 * state["fRec108"][1])) + (self._fConst497 * state["fRec108"][2]))) - (self._fConst492 * ((self._fConst518 * state["fRec107"][2]) + (self._fConst519 * state["fRec107"][1]))))) 
		state["fRec106"] = state["fRec106"].at[0].set(((self._fConst492 * (((self._fConst494 * state["fRec107"][0]) + (self._fConst520 * state["fRec107"][1])) + (self._fConst494 * state["fRec107"][2]))) - (self._fConst488 * ((self._fConst521 * state["fRec106"][2]) + (self._fConst522 * state["fRec106"][1]))))) 
		state["fRec105"] = ((fSlow2 * fRec105_temp) + (fSlow110 * jnp.abs((self._fConst488 * (((self._fConst491 * state["fRec106"][0]) + (self._fConst523 * state["fRec106"][1])) + (self._fConst491 * state["fRec106"][2])))))) 
		fVbargraph13 = (fSlow0 + (jnp.float32(2e+01) * jnp.log10(state["fRec105"])))
		# self.sow("intermediates", "fVbargraph13", fVbargraph13) 
		state["fRec115"] = state["fRec115"].at[0].set((fTemp49 - (self._fConst528 * ((self._fConst531 * state["fRec115"][2]) + (self._fConst532 * state["fRec115"][1]))))) 
		state["fRec114"] = state["fRec114"].at[0].set(((self._fConst528 * (((self._fConst530 * state["fRec115"][0]) + (self._fConst533 * state["fRec115"][1])) + (self._fConst530 * state["fRec115"][2]))) - (self._fConst526 * ((self._fConst534 * state["fRec114"][2]) + (self._fConst535 * state["fRec114"][1]))))) 
		state["fRec113"] = state["fRec113"].at[0].set(((self._fConst526 * (((self._fConst527 * state["fRec114"][0]) + (self._fConst536 * state["fRec114"][1])) + (self._fConst527 * state["fRec114"][2]))) - (self._fConst524 * ((self._fConst537 * state["fRec113"][2]) + (self._fConst538 * state["fRec113"][1]))))) 
		state["fRec112"] = ((fSlow2 * fRec112_temp) + (fSlow110 * jnp.abs((self._fConst524 * (((self._fConst525 * state["fRec113"][0]) + (self._fConst539 * state["fRec113"][1])) + (self._fConst525 * state["fRec113"][2])))))) 
