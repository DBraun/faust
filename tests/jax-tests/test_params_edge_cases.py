...
if __name__ == "__main__":
    print("="*60)
    print("Edge Case Testing: Params Argument with Special Features")
    print("="*60)

    all_passed = True

    try:
        if not test_soundfile_non_trainable_with_params():
            all_passed = False
    ...
    try:
        if not test_soundfile_trainable_with_params():
            all_passed = False
    except Exception as e:
    ...
    try:
        if not test_nentry_gumbel_with_params():
            all_passed = False
    except Exception as e:
    ...
    if all_passed:
        ...
        print()
        print("Summary:")
        print("  ✓ Non-trainable soundfiles work with params arg")
        print("  ✓ Trainable soundfiles work with params arg")
        print("  ✓ Nentry/Gumbel-softmax works with params arg")
        print("  ✓ Mixed parameters produce different outputs in vmap")
        print()
        print("READY TO IMPLEMENT IN FAUST BACKEND!")
    else:
        print("❌ SOME EDGE CASE TESTS FAILED")
        print("Need to address issues before implementing")
    print("="*60)
